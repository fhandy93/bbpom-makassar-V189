                                         ...
                                         <a href="javascript:void(0)">
                                             ...
                                             <span>
                                                <svg width="9" height="7" viewBox="0 0 9 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <path d="M4.47035e-08 2.145L1.275 0.854999L4.5 4.08L7.725 0.854999L9 2.145L4.5 6.645L4.47035e-08 2.145Z" fill="#0E2A46"/>
                                                 </svg>                                          
                                             </span>
                                         </a>
                     ...
                     <div class="row align-items-center">
                        <div class="col-xl-2 col-6">
                           <div class="it-header-2-logo">
                              <a href="/"><img src="{{asset('vendor/img/logo/logo5.png')}}" alt=""></a>
                           </div>
                        </div>
                           ...
                           <div class="it-header-2-main-menu">
                              <nav class="it-menu-content">
                                 <ul class="onepage-menu">
                                     @if($position == 'https://sipintar.bbpom-makassar.com/') 
                                       <li>
                                          <a href="#home">home</a>
                                       </li>
                                       <li><a href="#survey">Grafik Pengunjung</a></li>
                                       <li><a href="#item">Layanan</a></li>
                                       <li><a href="https://sipt.pom.go.id/pihak-3/login" target="_new">SIPT Pihak Ke-3</a></li>
                        ...
                        <div class="col-xl-4 col-6">
                           <div class="it-header-2-right d-flex align-items-center justify-content-end">
                              ...
                              <div class="it-header-2-button d-none d-md-block">
                                 <a class="it-btn" href="https://makassar.pom.go.id/">
                                    <span>
                                       Subsite BBPOM Makassar
