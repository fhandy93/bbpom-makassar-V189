    ...
    <div class="main-content app-content mt-0">
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                                ...
                                <div class="table-responsive">
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$index + 1}}</td>
                                                <td>{{ $item -> kat->title }}</td>
                                                <td>{!! $item -> tanya !!}</td>
                                                <td>{!! $item -> jawab !!}</td>
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                      
                                                        <!-- <a href="/bmn/admin/edit-data-ruangan/{{$item->id}}" class="btn btn-sm btn-info"><i class="fa fa-edit me-2"></i>Edit</a> -->
                                                        <!-- Tombol Delete -->
                                                        <!-- @if(checkPermission(['superadmin']))
                                                            <form method="POST" action="/bmn/admin/delete-ruang/{{ $item->id }}" class="d-inline">
                                                                @csrf
                ...
                <a href="/info-pom/faq/input-faq" class="btn btn-primary">Tambah QNA</a>
            </div>
        </div>
    </div>
