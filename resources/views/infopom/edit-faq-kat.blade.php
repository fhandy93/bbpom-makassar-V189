				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/info-pom/faq/update-faq-kat/{{$data->id}}" >
									@csrf
									@method('put')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{$data->title}}"  class="form-control  @error('title') is-invalid @enderror" id="title" name="title">
											@error('title')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{$data->nm_kategori}}"  class="form-control  @error('kat') is-invalid @enderror" id="kat" name="kat">
											@error('kat')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Update Kategori</button>
									</div>
