        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Daftar Kategori FAQ</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Infopom</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Daftar Kategori FAQ</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Daftar Kategori FAQ</h3>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <a href="/info-pom/faq/kategori/{{$item->id}}" class="btn btn-sm btn-info"><i class="fa fa-edit me-2"></i>Edit</a>
                                                        <!-- Tombol Delete -->
                                                        @if(checkPermission(['superadmin']))
                                                            <form method="POST" action="/info-pom/faq/delete-kategori/{{ $item->id }}" class="d-inline">
                                                                @csrf
                ...
                <a href="/info-pom/faq/input-kategori/" class="btn btn-primary">Tambah Kategori</a>
            </div>
        </div>
    </div>
