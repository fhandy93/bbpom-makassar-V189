        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Jawaban</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Infopom</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Input Jawaban</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
					...
					<div class="col-lg-6 col-md-6">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Input Jawaban</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/info-pom/qna/store-answ" >
									@csrf
									@method('post')
									<input type="text" value="{{$quest_id}}" id="parent" name="parent" hidden>
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="answer" class="form-label">Jawaban</label>
											<input type="text" value=""  class="form-control  @error('answer') is-invalid @enderror" id="answer" name="answer">
											@error('answer')
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Tambah Jawaban</button>
									</div>
