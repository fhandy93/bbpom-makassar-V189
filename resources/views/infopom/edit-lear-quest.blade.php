				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/info-pom/qna/update-store/{{$data->id}}" >
									@csrf
									@method('put')
									<input type="text" value="{{$data->kategori_id}}" id="komo" name="komo" hidden>
									<input type="text" value="{{$data->parent_answers_id}}" id="parent" name="parent" hidden>
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="quest" class="form-label">Pertanyaan</label>
											<input type="text" value="{{$data->questions}}"  class="form-control  @error('quest') is-invalid @enderror" id="quest" name="quest">
											@error('quest')
										...
										<div class="col-xl-12 mb-12 ">
											<span class="text-warning">*Tandai jika pertanyaan ini adalah pertanyaan akhir</span>
											 <label class="custom-control custom-checkbox">
												<input type="checkbox" class="custom-control-input" name="endquest" value="end" @if($data->status == 1) checked @endif> 
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Update Pertanyaan</button>
									</div>
