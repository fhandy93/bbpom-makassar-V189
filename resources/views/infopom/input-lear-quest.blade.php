        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Pertanyaan</h1>
                    <div>
                        <ol class="breadcrumb">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/info-pom/qna/store" >
									@csrf
									@method('post')
									<input type="text" value="{{$komo}}" id="komo" name="komo" hidden>
									<input type="text" value="{{$parent_id}}" id="parent" name="parent" hidden>
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="quest" class="form-label">Pertanyaan</label>
											<input type="text" value=""  class="form-control  @error('quest') is-invalid @enderror" id="quest" name="quest">
											@error('quest')
									...
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											<label for="detail" class="form-label">Detail Pertanyaan</label>
											<span class="text-warning">*Kosongkan jika pertanyaan tidak memiliki detail informasi</span>
											<textarea class="form-control editor @error('detail') is-invalid @enderror" rows="4" name="detail" id="detail"></textarea>
											@error('detail')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											<span class="text-warning">*Tandai jika pertanyaan ini adalah pertanyaan akhir</span>
											 <label class="custom-control custom-checkbox">
												<input type="checkbox" class="custom-control-input" name="endquest" value="end">
												<span class="custom-control-label">Pertanyaan Akhir</span>
											</label>		
										</div>
									</div>
									<p>
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Tambah Pertanyaan</button>
									</div>
