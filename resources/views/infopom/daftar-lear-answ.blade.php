        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Daftar Jawaban</h1>
                    <div>
                        <ol class="breadcrumb">
                ...
                <div class="row row-sm">
                    ...
                    @endif 
                    <div class="col-lg-12">
                         <p><a href="{{ session('parent_url') }}" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Kembali Ke halaman Awal</a></p>
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{$info->questions}}</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">Informasi Terkait jawaban</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-sm btn-info" onclick='showDetail(event, @json($item->detail))'>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        @if($info->status == 0)
                                                        <a href="/info-pom/qna/list-pertanyaan/{{$info->kategori_id}}/{{$item->id}}" class="btn btn-sm btn-success"><i class="fa fa-list-ul me-2"></i>Detail Pertanyaan</a>
                                                        @endif
                                                        <a href="/info-pom/qna/edit-answ/{{$item->id}}" class="btn btn-sm btn-info"><i class="fa fa-edit me-2"></i>Edit</a>
                                                        <!-- Tombol Delete -->
                                                        @if(checkPermission(['superadmin']))
                                                            <form method="POST" action="/info-pom/delete-answ/{{ $item->id }}" class="d-inline">
                                                                @csrf
                ...
                <a href="/info-pom/qna/input-answer/{{$info->id}}" class="btn btn-primary">Tambah Jawaban</a>
            </div>
        </div>
    </div>
