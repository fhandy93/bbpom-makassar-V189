        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Daftar Pertanyaan</h1>
                    <div>
                        <ol class="breadcrumb">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">Informasi Terkait Pertanyaan</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        <a href="/info-pom/qna/list-jawaban/{{$item->id}}" class="btn btn-sm btn-success"><i class="fa fa-list-ul me-2"></i>Detail Jawaban</a>
                                                        <a href="/info-pom/qna/edit-quest/{{$item->id}}" class="btn btn-sm btn-info"><i class="fa fa-edit me-2"></i>Edit</a>
                                                        <!-- Tombol Delete -->
                                                        @if(checkPermission(['superadmin']))
                                                            <form method="POST" action="/info-pom/delete-quest/{{ $item->id }}" class="d-inline">
                                                                @csrf
               ...
               @if(!empty($data) && count($data) == 0)
                    <a href="/info-pom/qna/input-question/{{$komo}}/{{$answer_id}}" class="btn btn-primary">Tambah Pertanyaan</a>
                @endif
