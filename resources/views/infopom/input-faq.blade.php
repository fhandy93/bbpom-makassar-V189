				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/info-pom/faq/store-faq" >
									@csrf
									@method('post')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<select name="kat" class="form-control form-select select2" >
												<option value="aa" selected disabled>Pilih Kategori ...</option>
												@foreach($kat as $item)
									...
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											...
											<textarea class="form-control editor @error('tanya') is-invalid @enderror" rows="4" name="tanya" id="tanya">{{ old('tanya') }}</textarea>
											@error('tanya')
                                    ...
                                    <div class="form-row">
										<div class="col-xl-12 mb-12 ">
											...
											<textarea class="form-control editor2 @error('jawab') is-invalid @enderror" rows="4" name="jawab" id="jawab">{{ old('jawab') }}</textarea>
											@error('jawab')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Tambah FAQ</button>
									</div>
