        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Kategori</h1>
                    <div>
                        <ol class="breadcrumb">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/info-pom/faq/store-faq-kat" >
									@csrf
									@method('post')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{old('nm_kategori')}}"  class="form-control  @error('kat') is-invalid @enderror" id="kat" name="kat">
											@error('kat')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Tambah Kategori</button>
									</div>
