                            ...
                            <div class="card-body">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body tabs-menu-body">
                                        <form id="signupForm" method="post" class="form-horizontal" action="/v3-rujukan-store" enctype="multipart/form-data">
                                        @csrf
                                        @method('post')			
                                            <div class="tab-content tab-validate">            
                                                ...
                                                <div class="tab-pane" id="tab11">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="editor form-control @error('desc') is-invalid @enderror" name="desc" id="desc">{{old('desc')}}</textarea>
                                                        @error('desc')
