        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Mikrobiologi</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Mikrobiologi Input</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
					...
					<div class="col-lg-6 col-md-6">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Tambah Mikrobiologi</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/mikrobiologis" >
									@csrf
									@method('post')			
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											<label for="nama" class="form-label">Nama Mirobiologi</label>
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{old('kataloq')}}"  class="form-control  @error('kataloq') is-invalid @enderror" id="kataloq" name="kataloq" >
											@error('kataloq')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
                                    ...
                                    <div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<input type="text" value="{{old('netto')}}"  class="form-control  @error('netto') is-invalid @enderror" id="netto" name="netto" >
											@error('netto')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
                                    ...
                                    <div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<input type="text" value="{{old('exp')}}"  class="form-control  @error('exp') is-invalid @enderror" id="exp" name="exp" >
											@error('exp')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:160px;">Tambah Mikrobiologi</button>
	...
	setTimeout(function() {
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
					nama: {
						required: "Nama Mikrobiologi harus diisi",
                    ...
                    exp: {
						required: "Kolom Date Exp. harus diisi",
					}			
                },
				errorElement: "em",
