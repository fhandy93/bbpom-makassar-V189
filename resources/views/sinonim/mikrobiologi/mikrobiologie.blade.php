        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Edit Mikrobiologi</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Mikrobiologi Edit</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<a href="/mikrobiologiv"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Mikrobiologi</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Edit Mikrobiologi</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/mikrobiologi/{{$mikro->id}}" >
									@csrf
									@method('put')
									
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											<label for="nama" class="form-label">Nama Mikrobiologi</label>
											<input type="text"   class="form-control  @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ $mikro->nama}}">
											@error('nama')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{ $mikro->kataloq}}"  class="form-control  @error('kataloq') is-invalid @enderror" id="kataloq" name="kataloq" >
											@error('kataloq')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
                                    ...
                                    <div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<input type="text" value="{{ $mikro->netto}}"  class="form-control  @error('netto') is-invalid @enderror" id="netto" name="netto" >
											@error('netto')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											<label for="netto" class="form-label">Tanggal Expired</label>
											<input type="text" value="{{$mikro->exp}}"  class="form-control  @error('exp') is-invalid @enderror" id="exp" name="exp" >
											@error('exp')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
                                    ...
                                    <div class="form-row">
										<div class="col-xl-4 mb-12 ">
											...
											<input type="text" value="{{ $mikro->stok}}"  class="form-control  @error('stok') is-invalid @enderror" id="stok" name="stok" readonly>
											@error('stok')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Update Mikrobiologi</button>
