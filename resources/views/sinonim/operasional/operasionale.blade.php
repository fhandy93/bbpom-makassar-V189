        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Edit Operasional Pengujian</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Operasional Pengujian Edit</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<a href="/operasionalv"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View OP</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Edit Operasional Pengujian</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/operasional/{{$opera->id}}" >
									@csrf
									@method('put')
									
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											<label for="nama" class="form-label">Nama Operasional Pengujian</label>
											<input type="text"   class="form-control  @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ $opera->nama}}">
											@error('nama')
                                    ...
                                    <div class="form-row">
										<div class="col-xl-4 mb-12 ">
											...
											<input type="text" value="{{ $opera->stok}}"  class="form-control  @error('stok') is-invalid @enderror" id="stok" name="stok" readonly>
											@error('stok')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Update OP</button>
	...
	setTimeout(function() {
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
					nama: {
						required: "Nama Operasional Pengujian harus diisi",
