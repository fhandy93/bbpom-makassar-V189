        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Edit Stok Operasional Pengujian</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Operasional Pengujian Edit Stok</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<a href="/operasional/{{ $data->id }}/detail"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Transaksi OP</button></a>
						<a href="/operasionalv"><button type="button" class="btn btn-success"><i class="fe fe-eye me-2"></i>View OP</button></a><p>	
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Edit Stok</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/operatrans" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="id" class="form-label">Nama Operasional Pengujian</label>
									...
									<div class="form-row">
										<div class="form-group col-xl-8 mb-12 ">
											...
											<select name="jenis" class="form-control form-select select2" data-bs-placeholder="Select Country">
													<option value="Transaksi Masuk" >IN-Transaksi Masuk</span></option>
													<option value="Transaksi Keluar Pangan" >OUT-Transaksi Keluar Pangan</option>
													<option value="Transaksi Keluar Obat" >OUT-Transaksi Keluar Obat</option>
													<option value="Transaksi Keluar Obat Tradisional" >OUT-Transaksi Keluar Obat Tradisional</option>
													<option value="Transaksi Keluar Kosmetik" >OUT-Transaksi Keluar Kosmetik</option>
													<option value="Transaksi Keluar Mikro"></option>OUT-Transaksi Keluar Mikro</option>
												</select>
										</div>
									</div>
									<div class="form-row">
