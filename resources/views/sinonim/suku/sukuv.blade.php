<x-HomeLayout>
        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data Suku Cadang</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Suku Cadang View</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Suku Cadang</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">No. APL</th>
                                                <th class="border-bottom-0">Nama Suku Cadang</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$suku -> kataloq}}</td>
                                                <td>{{$suku -> netto}}</td>
                                                <td @if($suku -> stok <= 0) style="color: red;"@endif><b>{{$suku -> stok}}</b></td>
                                                @if(checkPermission(['superadmin','perlengkapan']))
                                                <td>
                                                    <div class="btn-list">
                                                    <a href="/suku/{{$suku -> id}}/detail"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-secondary"><span  class="fe fe-eye">Detail</span></button></a>&nbsp;
                                                    <a href="/suku/{{$suku -> id}}/edit"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-primary"><span  class="fe fe-edit">Edit</span></button></a>
                                                        <form method="POST" action="sukud/{{ $suku -> id }}" style="display: inline;" >
                                                            @csrf
                ...
                @if(checkPermission(['superadmin','perlengkapan']))
                <a href="/suku"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Suku Cadang</button></a>
                <a href="/suku_formc"><button type="button" class="btn btn-success">Cetak Laporan Akhir Bulanan</button></a>
                @endif
                @if(checkPermission(['superadmin']))
                <a href="/rekap_suku"><button type="button" class="btn btn-warning show_confirm2">Input Stok Akhir Bulanan</button></a>
                @endif
                <p>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Petunjuk Stok Suku Cadang</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <p>Tuliskan Nama Suku Cadang didalam kolom pencarian (Search box) untuk mempermudah menemukan Stok Suku Cadang yang dicari</p>
                </div>
    ...
    setTimeout(function() {
        ...
        $('.show_confirm2').click(function(event) {
            ...
            event.preventDefault();
            swal({
                title: `Anda yakin ingin menginput STOK AKHIR BULAN Suku Cadang ?`,
