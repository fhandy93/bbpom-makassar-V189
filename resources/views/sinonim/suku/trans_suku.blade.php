        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Edit Stok Suku Cadang</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Suku Cadang Edit Stok</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<a href="/suku/{{ $data->id }}/detail"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Transaksi Suku Cadang</button></a>
						<a href="/sukuv"><button type="button" class="btn btn-success"><i class="fe fe-eye me-2"></i>View Suku Cadang</button></a><p>	
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Edit Stok</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/sukutrans" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="id" class="form-label">Nama Suku Cadang</label>
