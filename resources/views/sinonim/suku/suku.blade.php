        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Suku Cadang</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Suku Cadang Input</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						...
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/sukus" >
									@csrf
									@method('post')		
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="no_apl" class="form-label">No. APL(Kode Barang)</label>
											<input type="text" value="{{old('no_apl')}}"  class="form-control  @error('no_apl') is-invalid @enderror" id="no_apl" name="no_apl" >
											@error('no_apl')
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:160px;">Tambah Suku Cadang</button>
