    ...
    <div class="main-content app-content mt-0">
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    ...
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Inventory View</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">Nama Bidang Inventory</th>
                                                <th class="border-bottom-0">Keterangan</th>
                                                <th class="border-bottom-0">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                             @foreach($bidang as $index => $bidang)
                                            <tr>
                                                <td>{{$index + 1}}</td>
                                                <td>{{$bidang -> nama}}</td>
                                                <td>{{$bidang -> ket}}</td>
                                                <td>
                                                    <div class="btn-list">
                                                        <form method="POST" action="inventoryd/{{ $bidang -> id }}" style="display: inline;" >
                                                            @csrf
                ...
                <a href="/inventory"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Bidang</button></a>
            </div>
        </div>
    </div>
    <!-- CONTAINER CLOSED -->
