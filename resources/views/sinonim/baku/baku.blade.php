        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Baku Pembanding</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Baku Pembanding Input</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
					...
					<div class="col-lg-6 col-md-6">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Tambah Baku Pembanding</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/bakus" >
									@csrf
									@method('post')		
									<div class="form-row">
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{old('no_kontrol')}}"  class="form-control  @error('no_kontrol') is-invalid @enderror" id="no_kontrol" name="no_kontrol" >
											@error('no_kontrol')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-4 mb-12 ">
											...
											<input type="text" value="{{old('bobot')}}"  class="form-control  @error('bobot') is-invalid @enderror" id="bobot" name="bobot" >
											@error('bobot')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:160px;">Tambah Baku</button>
