        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Edit Stok Baku Pembanding</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Baku Pembanding Edit Stok</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<a href="/baku/{{ $data->id }}/detail"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Transaksi Baku Pembanding</button></a>
						<a href="/bakuv"><button type="button" class="btn btn-success"><i class="fe fe-eye me-2"></i>View Baku Pembanding</button></a><p>	
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Edit Stok</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/bakutrans" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="id" class="form-label">Nama Baku Pembanding</label>
