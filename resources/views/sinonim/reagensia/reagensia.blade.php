        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Reagensia</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Reagensia Input</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
					...
					<div class="col-lg-6 col-md-6">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Tambah Reagensia</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/reagensias" >
									@csrf
									@method('post')			
									<div class="form-row">
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Tambah Reagensia</button>
