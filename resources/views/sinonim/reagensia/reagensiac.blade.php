        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data Akhir Bulan Reagensia</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Data Akhir Bulan Reagensia</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                             @foreach($reagen as $index => $reagen)
                                            <tr>
                                                <td>{{$index + 1}}</td>
                                                <td>{{$reagen -> kataloq}}</td>
                                                <td>{{$reagen -> nama}}</td>
                                                <td>{{$reagen -> netto}}</td>
                                                <td>{{$reagen -> stok}}</td>
                                                <td></td>
        ...
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content modal-content-demo">
                <div class="modal-header">
                    <h6 class="modal-title">Petunjuk Cetak reagen Pembanding</h6><button aria-label="Close" class="btn-close" data-bs-dismiss="modal"><span aria-hidden="true">&times;</span></button>
                </div>
