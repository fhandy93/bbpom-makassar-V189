        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Alat Gelas Kuantitatif</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Alat Gelas Kuantitatif Input</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
					...
					<div class="col-lg-6 col-md-6">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Tambah Alat Gelas Kuantitatif</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/kuantitatifs" >
									@csrf
									@method('post')		
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="bmn" class="form-label">No. BMN</label>
											<input type="text" value="{{old('bmn')}}"  class="form-control  @error('bmn') is-invalid @enderror" id="bmn" name="bmn" >
											@error('bmn')
									...
									<div class="form-row">
										<div class="col-xl-4 mb-12 ">
											...
											<input type="text" value="{{old('ukuran')}}"  class="form-control  @error('ukuran') is-invalid @enderror" id="ukuran" name="ukuran" >
											@error('ukuran')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:160px;">Tambah Alat Gelas</button>
