        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Edit Alat Gelas Kuantitatif</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Alat Gelas Kuantitatif Edit</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<a href="/kuantitatifv"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Alat Gelas Kuantitatif</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Edit Alat Gelas Kuantitatif</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/kuantitatif/{{$kuan->id}}" >
									@csrf
									@method('put')
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="bmn" class="form-label">No. BMN</label>
											<input type="text" value="{{ $kuan->bmn }}"  class="form-control  @error('bmn') is-invalid @enderror"  id="bmn" name="bmn" >
											@error('bmn')
									...
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											<label for="nama" class="form-label">Nama Alat Gelas Kuantitatif</label>
											<input type="text"   class="form-control  @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ $kuan->nama}}">
											@error('nama')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-5 mb-12 ">
											...
											<input type="text" value="{{ $kuan->merek }}"  class="form-control  @error('merek') is-invalid @enderror" id="merek" name="merek" >
											@error('merek')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-4 mb-12 ">
											...
											<input type="text" value="{{ $kuan->ukuran }}"  class="form-control  @error('ukuran') is-invalid @enderror" id="ukuran" name="ukuran" >
											@error('ukuran')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Update Alat Gelas</button>
	...
	setTimeout(function() {
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
					nama: {
						required: "Nama Alat Gelas harus diisi",
						minlength: "Harus berisi minimal 2 karakter"
					},
					merek: {
						required: "Kolom Merek harus diisi"
					},
                    ukuran: {
						required: "Kolom Ukuran harus diisi"
					},
                    bmn: {
						required: "Kolom No. BMN harus diisi",
					}			
                },
				errorElement: "em",
