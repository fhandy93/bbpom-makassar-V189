        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Edit Alat Gelas Kualitatif</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sinonim</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Alat Gelas Kualitatif Edit</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<a href="/kualitatifv"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Alat Gelas Kualitatif</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Edit Alat Gelas Kualitatif</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/kualitatif/{{$kual->id}}" >
									@csrf
									@method('put')
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="bmn" class="form-label">No. BMN</label>
											<input type="text" value="{{ $kual->bmn }}"  class="form-control  @error('bmn') is-invalid @enderror"  id="bmn" name="bmn" >
											@error('bmn')
									...
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											<label for="nama" class="form-label">Nama Alat Gelas Kualitatif</label>
											<input type="text"   class="form-control  @error('nama') is-invalid @enderror" id="nama" name="nama" value="{{ $kual->nama}}">
											@error('nama')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-4 mb-12 ">
											...
											<input type="text" value="{{ $kual->ukuran }}"  class="form-control  @error('ukuran') is-invalid @enderror" id="ukuran" name="ukuran" >
											@error('ukuran')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
