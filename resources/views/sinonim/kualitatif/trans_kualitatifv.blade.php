        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data Transaksi Alat Gelas Kualitatif</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)"> Alat Gelas Kualitatif</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Transaksi Alat Gelas Kualitatif View</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                <div class="row row-sm">
                    ...
                    <div class="col-lg-12">
                        ...
                        <a href="/kualitatiftrans/{{ $trans['id'] }}"><button type="button" style="width: 200px;" class="btn btn-primary"><span  class="fe fe-edit">  Edit Stok</span></button></a><p>
                        @endif
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Transaksi Alat Gelas Kualitatif</h3>
                            </div>
