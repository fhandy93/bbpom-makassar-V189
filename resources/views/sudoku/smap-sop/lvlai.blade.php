					...
					<div class="col-lg-8 col-md-8">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Input SOP</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/smap-sop/sop-store" >
									@csrf
									@method('post')
