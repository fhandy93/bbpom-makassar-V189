        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data File SMAP - SOP</h1>
                    <div>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">SMAP - SOP</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">File Preview</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item -> judul }}</td>
                                                <td>
                                                    <form method="POST" action="/smap-sop/{{$item -> id}}/view-file"  >
                                                        @csrf
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/smap-sop/{{$item -> id}}/detail-revisi"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-secondary" data-toggle="tooltip" title='Detail'><span  class="fe fe-align-justify"> Detail Revisi</span></button></a>&nbsp;
                                                        <a href="/smap-sop/{{$item -> id}}/edit"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-info" data-toggle="tooltip" title='Edit'><span  class="fe fe-edit"> Edit Data</span></button></a>&nbsp;
                                                        @if(checkPermission(['superadmin','laboratorium']))
                                                        <form method="POST" action="/smap-sop/{{ $item -> id }}/delete" style="display: inline;" >
                                                            @csrf
                ...
                @if(checkPermission(['superadmin','laboratorium']))
                <a href="/smap-sop/input-sop/"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah SOP</button></a>
                @endif
                <p>
            </div>
        </div>
