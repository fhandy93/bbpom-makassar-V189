        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Edit SMAP-SOP</h1>
                    <div>
                        <ol class="breadcrumb">
				...
				@if (session() -> has('success'))
					...
					<div class="col-lg-8 col-md-8">
						<a href="/smap-sop"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View SOP</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Edit SOP </h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/smap-sop/{{ $data->id }}/update" >
									@csrf
									@method('put')
