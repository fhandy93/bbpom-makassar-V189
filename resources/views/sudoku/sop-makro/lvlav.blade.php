    ...
    <div class="main-content app-content mt-0">
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    ...
                    <div>
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">SUDOKU</a></li>
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Peta Proses Bisnis</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Peta Proses Bisnis</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">Kode Peta Proses Bisnis</th>
                                                <th class="border-bottom-0">Proses Bisnis</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item -> kode_proses}}</td>
                                                <td>{{$item -> nm_proses }}</td>
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/sub-proses-bisnis/{{$item -> id}}"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-secondary" data-toggle="tooltip" title='Detail'><span  class="fe fe-align-justify"> Detail Sub Proses</span></button></a>&nbsp;
                                                        <a href="/edit-peta-proses-bisnis/{{$item -> id}}"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-info" data-toggle="tooltip" title='Edit'><span  class="fe fe-edit"> Edit Data</span></button></a>&nbsp;
                                                        @if(checkPermission(['superadmin']))
                                                        <form method="POST" action="/proses-bisnis/{{ $item -> id }}/delete" style="display: inline;" >
                                                            @csrf
                ...
                <a href="/proses-bisnis-input"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Peta Proses Bisnis</button></a>
                @endif
                <p>
            </div>
        </div>
