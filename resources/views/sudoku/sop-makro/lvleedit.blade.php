        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
				...
				<div class="row">
                    ...
                    <a href="/sop-makro/{{$id->sop_id}}/detail"><button type="button" class="btn btn-primary"><i class="fe fe-arrow-left me-2"></i>Kembali</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Update Revisi</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/makro-revisi-update/{{$id->id}}" >
									@csrf
									@method('put')
                                    <div class="form-row">
