    ...
    <div class="main-content app-content mt-0">
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    ...
                    <div>
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">SUDOKU</a></li>
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Peta Lintas Fungsi</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Peta Lintas Fungsi</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">Kode Peta Lintas Fungsi</th>
                                                <th class="border-bottom-0">Peta Lintas Fungsi</th>
                                        ...
                                        <tbody>
                                             @foreach($lvlc as $index => $item)
                                            <tr>
                                             
                                                <td>{{$item -> kode_peta}}</td>
                                                <td>{{$item -> nm_peta }}</td>
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/sop-makro/{{$item -> id}}"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-secondary" data-toggle="tooltip" title='Detail'><span  class="fe fe-align-justify"> Detail SOP Makro</span></button></a>&nbsp;
                                                        <a href="/edit-lintas-fungsi/{{$item -> id}}"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-info" data-toggle="tooltip" title='Edit'><span  class="fe fe-edit"> Edit Data</span></button></a>&nbsp;
                                                        @if(checkPermission(['superadmin']))
                                                         <form method="POST" action="/lintas-fungsi/{{ $item -> id }}/delete" style="display: inline;" >
                                                            @csrf
                ...
                <a href="/peta-lintas-fungsi-input/{{$proses_id}}"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Peta Lintas Fungsi</button></a>
                @endif
                <p>
            </div>
        </div>
