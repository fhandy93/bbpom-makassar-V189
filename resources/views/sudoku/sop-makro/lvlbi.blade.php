        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Peta Sub Proses Bisnis</h1>
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Input Peta Sub Proses Bisnis</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						<a href="/sub-proses-bisnis/{{$proses_id}}"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Peta Sub Proses Bisnis</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Tambah Peta Sub Proses Bisnis</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/proses-bisnis-store/{{$proses_id}}" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											<label for="kode" class="form-label">Kode Peta Sub Proses Bisnis</label>
											<input type="text" value="{{$kode->kode_proses}}."  class="form-control  @error('kode') is-invalid @enderror" id="kode" name="kode" >
											@error('kode')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="nama" class="form-label">Nama Peta Sub Proses Bisnis</label>
