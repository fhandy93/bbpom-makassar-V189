        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Pedoman Teknis Laboratorium</h1>
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Input Pedoman Teknis Laboratorium</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						<a href="/ptl"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Pedoman Teknis Lab.</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Input Pedoman Teknis Laboratorium</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/ptl-store" >
									@csrf
									@method('post')
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
					...
					judul: {
						required: "Judul PTL harus diisi"
					}			
                },
				errorElement: "em",
