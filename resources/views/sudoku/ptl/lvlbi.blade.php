            ...
            <div class="main-container container-fluid">
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						<a href="/ptl-revisi/{{$ptl}}"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Detail Revisi</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Input Revisi Pedoman Jaminan Mutu Laboratorium</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/ptl-revisi-store/{{$ptl}}" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											<label for="kode" class="form-label">No. Dokumen</label>
											<input type="text" value="{{$kode->ptl_kode}}"  class="form-control  @error('kode') is-invalid @enderror" id="kode" name="kode" readonly>
											@error('kode')
