        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data File Revisi Pedoman Teknis Laboratorium</h1>
                    <div>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Revisi Pedoman Teknis Laboratorium</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">Kode Pedoman Teknis Lab.</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/edit-ptl-revisi/{{ $item->id }}"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-warning" data-toggle="tooltip" title='Edit'><span  class="fe fe-align-justify"> Edit Revisi</span></button></a>&nbsp;
                                                        <form method="POST" action="/ptl-revisi/{{ $item -> id }}/delete" style="display: inline;" >
                                                            @csrf
                ...
                @if(checkPermission(['superadmin','laboratorium']))
                <a href="/ptl-revisi-input/{{$proses_id}}"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Revisi</button></a>
                @endif
                <p>
            </div>
        </div>
