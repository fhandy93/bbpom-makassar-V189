        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input SOP Mikro</h1>
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Input SOP Mikro</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						<a href="/detail-mikro/{{$lvla}}"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Detail SOP Mikro</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Input SOP Mikro</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/sop-mikro-store" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="makro_kode" class="form-label">Kode SOP Makro</label>
											<input type="text" value="{{$lvla}}"  class="form-control  @error('makro_kode') is-invalid @enderror " id="makro_kode" name="makro_kode" readonly>
											@error('makro_kode')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="mikro_kode" class="form-label">Kode SOP Mikro</label>
											<input type="text" value="{{$lvla}}/"  class="form-control  @error('mikro_kode') is-invalid @enderror " id="mikro_kode" name="mikro_kode" >
											@error('mikro_kode')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="nama" class="form-label">Nama SOP Mikro</label>
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
					...
					mikro_kode: {
						required: "Kode SOP Mikro harus diisi"
					},
					file: {
						required: "file Upload harus diisi"
					},
					nama: {
						required: "Nama SOP Mikro harus diisi"
					}			
                },
				errorElement: "em",
