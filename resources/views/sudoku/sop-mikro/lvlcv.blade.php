        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data File Revisi SOP Mikro</h1>
                    <div>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Revisi SOP Mikro</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                      <a href="/edit-mikro-revisi/{{ $item->id }}"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-warning" data-toggle="tooltip" title='Edit'><span  class="fe fe-align-justify"> Edit Revisi</span></button></a>&nbsp;
                                                        <form method="POST" action="/mikro-revisi/{{ $item -> id }}/delete" style="display: inline;" >
                                                            @csrf
                ...
                @if(checkPermission(['superadmin','laboratorium']))
                <a href="/mikro-revisi-input/{{$proses_id}}"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Revisi</button></a>
                @endif
                <p>
            </div>
        </div>
