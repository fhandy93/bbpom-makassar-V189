        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">SOP Makro Induk</h1>
                    <div>
                        <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">SUDOKU</a></li>
                            ...
                            <li class="breadcrumb-item active" aria-current="page">SOP Makro Induk</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">SOP Makro Induk</h3>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                <th class="border-bottom-0">Kode SOP Makro Turunan</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item -> kode_makro}}</td>
                                                <td>{{$item -> user->username }}</td> 
                                                <td>{{$item -> created_at }}</td>
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/detail-mikro/{{$item -> kode_makro}}"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-secondary" data-toggle="tooltip" title='Detail'><span  class="fe fe-align-justify"> Detail Mikro</span></button></a>&nbsp;
                                                        @if(checkPermission(['superadmin','laboratorium']))
                                                        <form method="POST" action="/makro-induk/{{ $item->id }}/delete" style="display: inline;" >
                                                            @csrf
                ...
                @if(checkPermission(['superadmin','laboratorium']))
                <a href="/mikro-induk-input"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah SOP Makro  Induk</button></a>
                @endif
                <p>
            </div>
        </div>
