        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input SOP Makro Induk</h1>
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Input SOP Makro Induk</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">  	
					...
					<div class="col-lg-8 col-md-8">
						<a href="/mikro"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View SOP Makro Induk</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Tambah SOP Makro Induk</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/sop-makro-induk-store" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											<label for="makro_kode" class="form-label">Kode SOP Makro</label>
											<select  name="makro_kode" class="form-control form-select select2" data-bs-placeholder="Select Country">
												@foreach ($makro as $data)
												<option value="{{$data -> kode_sop}}">{{$data -> kode_sop}}</option>
												@endforeach
											</select>
										</div>
									</div>
