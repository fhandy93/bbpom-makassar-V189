        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data File Instruksi Kerja</h1>
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Instruksi Kerja</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Mutu Lab. (Induk: {{$lvla}})</h3>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                <th class="border-bottom-0">Kode Instruksi Kerja</th>
                                                <th class="border-bottom-0">Judul Instruksi Kerja</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$item -> instrumen_kode}}</td>
                                                <td>{{$item -> judul_sop }}</td>
                                                <td>
                                                    <form method="POST" action="/instruksi-kerja-view/{{$item -> id}}"  >
                                                        @csrf
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/instrumen-revisi/{{$item -> id}}"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-secondary" data-toggle="tooltip" title='Detail'><span  class="fe fe-align-justify"> Detail Revisi</span></button></a>&nbsp;
                                                        <a href="/edit-instruksi-kerja/{{$item -> id}}"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-info" data-toggle="tooltip" title='Edit'><span  class="fe fe-edit"> Edit Data</span></button></a>&nbsp;
                                                        @if(checkPermission(['superadmin','laboratorium']))
                                                        <form method="POST" action="/instruksi-kerja/{{ $item->id }}/delete" style="display: inline;" >
                                                            @csrf
                ...
                @if(checkPermission(['superadmin','laboratorium']))
                <a href="/detail-instruksi-kerja-input/{{$id}}"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Instruksi Kerja</button></a>
                @endif
                <p>
            </div>
        </div>
