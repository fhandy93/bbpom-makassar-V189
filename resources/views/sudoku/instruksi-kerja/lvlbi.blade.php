        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Instruksi Kerja</h1>
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Input Instruksi Kerja</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						<a href="/detail-instruksi-kerja/{{$id}}"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Detail Instruksi Kerja</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Input Instruksi Kerja</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/instruksi-kerja-store" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="mutu_kode" class="form-label">Kode Mutu Laboratorium</label>
											<input type="text" value="{{$lvla}}"  class="form-control  @error('mutu_kode') is-invalid @enderror " id="mutu_kode" name="mutu_kode" readonly>
											@error('mutu_kode')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="ins_kode" class="form-label">Kode Instruksi Kerja</label>
											<input type="text" value="{{old('ins_kode')}}"  class="form-control  @error('ins_kode') is-invalid @enderror " id="ins_kode" name="ins_kode" >
											@error('ins_kode')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="judul" class="form-label">Judul Instruksi Kerja</label>
	...
	setTimeout(function() {
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
					mutu_kode: {
						required: "Kode Mutu Lab. harus diisi"
					},
					ins_kode: {
						required: "Kode Instruksi Kerja harus diisi"
					},
					file: {
						required: "file Upload harus diisi"
					},
					judul: {
						required: "Judul Instruksi Kerja harus diisi"
					}			
                },
				errorElement: "em",
