        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Revisi Instruksi Kerja</h1>
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Input Revisi Instruksi Kerja</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						<a href="/instrumen-revisi/{{$proses_id}}"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Revisi Instruksi Kerja</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Tambah Revisi Instruksi Kerja</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/instruksi-revisi-store/{{$proses_id}}" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											<label for="kode" class="form-label">Kode Instruksi Kerja</label>
											<input type="text" value="{{$kode->instrumen_kode}}"  class="form-control  @error('kode') is-invalid @enderror" id="kode" name="kode" readonly>
											@error('kode')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="nama" class="form-label">Judul Instruksi Kerja</label>
