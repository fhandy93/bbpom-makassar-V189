            ...
            <div class="main-container container-fluid">
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						<a href="/detail-formulir/{{$id}}"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Detail Formulir Dokumen Pendukung</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Input Formulir Dokumen Pendukung</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/detail-formulir-store" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="induk_kode" class="form-label">Kode Induk (Mutu Laboratorium/Instruksi Kerja)</label>
											<input type="text" value="{{$lvla}}"  class="form-control  @error('induk_kode') is-invalid @enderror " id="induk_kode" name="induk_kode" readonly>
											@error('induk_kode')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="form_kode" class="form-label">Kode Formulir</label>
											<input type="text" value="{{old('form_kode')}}"  class="form-control  @error('form_kode') is-invalid @enderror " id="form_kode" name="form_kode" >
											@error('form_kode')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
	...
	setTimeout(function() {
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
					induk_kode: {
						required: "Induk Kode harus diisi"
					},
					form_kode: {
						required: "Kode Formulir harus diisi"
					},
					file: {
						required: "file Upload harus diisi"
					},
					judul: {
						required: "Judul Formulir harus diisi"
					}			
                },
				errorElement: "em",
