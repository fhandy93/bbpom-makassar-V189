        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Edit Formulir Dokumen Pendukung</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SUDOKU</a></li>
							<li class="breadcrumb-item active" aria-current="page">Edit Formulir Dokumen Pendukung</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
					...
					<div class="col-lg-8 col-md-8">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Edit Formulir Dokumen Pendukung</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/update-formulir/{{ $data->id }}" >
									@csrf
									@method('put')
									...
									<div class="form-row">
										<div class="col-xl-4 mb-12 ">
											...
											<input type="text" value="{{ $data->formulir_kode }}"  class="form-control  @error('kode') is-invalid @enderror" id="kode" name="kode" >
											@error('kode')
	...
	setTimeout(function() {
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
					kode: {
						required: "Kode Formulir Kerja harus diisi"
					},
					nama: {
						required: "Judul Formulir Kerja diisi"
					}			
                },
				errorElement: "em",
