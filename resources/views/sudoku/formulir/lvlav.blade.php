        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Formulir Dokumen Pendukung Induk</h1>
                    <div>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Formulir Dokumen Pendukung</h3>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                <th class="border-bottom-0">Kode Induk (PTL/SOP Mikro/Mutu Laboratorium/Instruksi Kerja)</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item -> induk_kode}}</td>
                                                <td>{{$item -> user->username }}</td> 
                                                <td>{{$item -> created_at }}</td>
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/detail-formulir/{{$item -> id}}"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-secondary" data-toggle="tooltip" title='Detail'><span  class="fe fe-align-justify"> Detail Formulir</span></button></a>&nbsp;
                                                        @if(checkPermission(['superadmin','laboratorium']))
                                                        <form method="POST" action="/formulir-induk/{{ $item->id }}/delete" style="display: inline;" >
                                                            @csrf
                ...
                @if(checkPermission(['superadmin','laboratorium']))
                <a href="/dokumen-pendukung-input"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Dokumen Pendukung Induk</button></a>
                @endif
                <p>
            </div>
        </div>
