        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data File SMAP - IK</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SMAP</a></li>
                            <li class="breadcrumb-item active" aria-current="page">SMAP</li>
                            <li class="breadcrumb-item active" aria-current="page">IK</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">SMAP - IK</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item -> judul }}</td>
                                                <td>
                                                    <form method="POST" action="/smap-ik/{{$item -> id}}/view-file"  >
                                                        @csrf
                                                ...
                                                <td>{{$item -> smapDet -> max('tgl_terbit') }}</td>
                                                <td>{{$item -> smapDet -> max('revisi') }}</td>
                                                <td>Aktif Berlaku</td>
                                                <td>{{$item -> user->username }}</td> 
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/smap-ik/{{$item -> id}}/detail-revisi"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-secondary" data-toggle="tooltip" title='Detail'><span  class="fe fe-align-justify"> Detail Revisi</span></button></a>&nbsp;
                                                        <a href="/smap-ik/{{$item -> id}}/edit"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-info" data-toggle="tooltip" title='Edit'><span  class="fe fe-edit"> Edit Data</span></button></a>&nbsp;
                                                        @if(checkPermission(['superadmin','laboratorium']))
                                                        <form method="POST" action="/smap-ik/{{ $item -> id }}/delete" style="display: inline;" >
                                                            @csrf
                ...
                @if(checkPermission(['superadmin','laboratorium']))
                <a href="/smap-ik/input-ik/"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah IK</button></a>
                @endif
                <p>
            </div>
        </div>
