            ...
            <div class="main-container container-fluid">
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						<a href="/smap-ik/{{$id}}/detail-revisi"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Detail Revisi</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Input Revisi IK</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/smap-ik/{{$id}}/input-revisi" >
									@csrf
									@method('post')
									<div class="form-row">
