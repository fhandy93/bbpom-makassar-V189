            ...
            <div class="main-container container-fluid">
				...
				@if (session() -> has('success'))
					...
					<div class="col-lg-8 col-md-8">
						<a href="/smap-ik"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View IK</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Edit IK </h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/smap-ik/{{ $data->id }}/update" >
									@csrf
									@method('put')
