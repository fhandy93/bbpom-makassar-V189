					...
					<div class="col-lg-8 col-md-8">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Input IK</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/smap-ik/ik-store" >
									@csrf
									@method('post')
