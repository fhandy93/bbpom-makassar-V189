        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Revisi Pedoman Jaminan Mutu Laboratorium</h1>
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Input Revisi Pedoman Jaminan Mutu Laboratorium</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						<a href="/detail-revisi-mutu/{{$mutu}}"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Detail Revisi</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Input Revisi Pedoman Jaminan Mutu Laboratorium</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/revisi-mutu-store/{{$mutu}}" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											<label for="kode" class="form-label">No. Dokumen</label>
											<input type="text" value="{{$kode->mutu_kode}}"  class="form-control  @error('kode') is-invalid @enderror" id="kode" name="kode" readonly>
											@error('kode')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{$kode->judul}}"  class="form-control  @error('nama') is-invalid @enderror" id="nama" name="nama" readonly >
											@error('nama')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
