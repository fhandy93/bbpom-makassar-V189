        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data File Manual Organisasi</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Level A</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Manual Organisasi</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Manual Organisasi</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form method="POST" action="/file_man_org/{{$item -> id}}"  >
                                                        @csrf
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/man_org/{{$item -> id}}/detail"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-secondary" data-toggle="tooltip" title='Detail'><span  class="fe fe-align-justify"> Detail Judul</span></button></a>&nbsp;
                                                        @if(checkPermission(['superadmin','laboratorium']))
                                                        <form method="POST" action="man_org/{{ $item -> id }}/delete" style="display: inline;" >
                                                            @csrf
                ...
                <a href="/manual_org_input"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Manual Organisasi</button></a>
                @endif
                <p>
            </div>
        </div>
