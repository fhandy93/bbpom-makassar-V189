				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						...
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" enctype="multipart/form-data" action="/man-org-judul-store/{{$data->id}}" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-4 mb-12 ">
											<label for="nama" class="form-label">Nama Dokumen</label>
											<input type="text" value="{{$data->judul}}"  class="form-control  @error('nm_dokumen') is-invalid @enderror" id="nm_dokumen" name="nm_dokumen" >
											@error('dokumen')
                                    ...
                                    <div class="form-row">
										<div class="col-xl-6 mb-12 ">
											<label for="nama" class="form-label">No. Dokument</label>
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<div class="input-group">
												...
												<input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" value="00/00/0000" type="text" name="tgl_terbit" id="tgl_terbit">
											</div>
											@error('tgl_terbit')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
