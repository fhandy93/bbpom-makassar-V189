        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Detail Revisi</h1>
                    <div>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Detail Revisi</h3>
                            </div>
                            <div class="card-body">
                ...
                <a href="/detail-revisi-input/{{$lvla}}/{{$data_id}}/{{$cat}}"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Revisi</button></a>
                @endif
                <p>
            </div>
        </div>
