        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data Storage SUDOKU</h1>
                    <div>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Data Storage SUDOKU</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{substr($item -> file, 34) }}</td>
                                                <td>{{$item -> ket }}</td> 
                                                <td>{{$item -> created_at }}</td>
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/sudoku-storage-download{{$item -> file}}"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-secondary"><span  class="fe fe-download"> Download</span></button></a>&nbsp;
                                                        @if(Auth::user()-> id == $item -> user_id)
                                                            <form method="POST" action="/sudoku-storage/{{ $item -> id }}/delete" style="display: inline;" >
                                                                @csrf
                ...
                <a href="/sudoku-storage-add"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah File</button></a>
                <p>
            </div>
        </div>
    </div>
    ...
    setTimeout(function() {
        ...
        $('.show_confirm').click(function(event) {
            ...
            swal({
                ...
                text: "Data akan dihapus dari database SUDOKU.",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
