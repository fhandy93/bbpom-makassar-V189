        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data File Revisi SMAP - Pedoman</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SUDOKU</a></li>
                            <li class="breadcrumb-item active" aria-current="page">SMAP - Pedoman</li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Revisi SMAP - Pedoman</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/smap-pedoman/{{ $item->id }}/edit-revisi"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-warning" data-toggle="tooltip" title='Edit'><span  class="fe fe-align-justify"> Edit Revisi</span></button></a>&nbsp;
                                                        <form method="POST" action="/smap-pedoman/{{ $item -> id }}/delete-revisi" style="display: inline;" >
                                                            @csrf
                ...
                @if(checkPermission(['superadmin','laboratorium']))
                <a href="/smap-pedoman/revisi/{{$pedoman_id}}/input-revisi"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Revisi</button></a>
                @endif
                <p>
            </div>
        </div>
