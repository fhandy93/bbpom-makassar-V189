        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Update Revisi</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SUDOKU</a></li>
							<li class="breadcrumb-item active" aria-current="page">Level D</li>
							<li class="breadcrumb-item active" aria-current="page">Update Revisi</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
                    ...
                    <a href="/smap-pedoman/{{$id->smap_id}}/detail-revisi"><button type="button" class="btn btn-primary"><i class="fe fe-arrow-left me-2"></i>Kembali</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Update Revisi</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/smap-pedoman/{{$id->id}}/update-revisi" >
									@csrf
									@method('put')
                                    <div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<div class="input-group">
												...
												<input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" value="{{$id->tgl_terbit}}" type="text" name="tgl_terbit" id="tgl_terbit">
											</div>
											@error('tgl_terbit')
									...
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											<label for="no_rev" class="form-label">No. Revisi</label>
											<input type="number" value="{{$id->revisi}}"  class="form-control  @error('judul') is-invalid @enderror " id="no_rev" name="no_rev" >
											@error('no_rev')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
											...
											<div class="form-group">
												...
												<div class="custom-controls-stacked">
													<label class="custom-control custom-radio">
															<input type="radio" class="custom-control-input" name="waktu" value=1 @if($id->waktu == 1) checked @endif>
															<span class="custom-control-label">Aktif Berlaku</span>
													</label>
													<label class="custom-control custom-radio">
															<input type="radio" class="custom-control-input" name="waktu" value=2 @if($id->waktu == 2) checked @endif>
															<span class="custom-control-label">Aktif Tidak Berlaku</span>
													</label>
													<label class="custom-control custom-radio">
															<input type="radio" class="custom-control-input" name="waktu" value=3 @if($id->waktu == 3) checked @endif>
	...
	setTimeout(function() {
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
					no_rev: {
						required: "No. Revisi harus diisi"
					},
