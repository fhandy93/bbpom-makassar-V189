            ...
            <div class="main-container container-fluid">
				...
				@if (session() -> has('success'))
					...
					<div class="col-lg-8 col-md-8">
						<a href="/smap-pedoman"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Pedoman</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Edit Pedoman </h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/smap-pedoman/{{ $data->id }}/update" >
									@csrf
									@method('put')
									...
									<div class="form-row">
										<div class="col-xl-4 mb-12 ">
											...
											<input type="text" value="{{ $data->klausul }}"  class="form-control  @error('klausul') is-invalid @enderror" id="klausul" name="klausul" >
											@error('klausul')
									...
									<div class="form-row">
										<div class="col-xl-4 mb-12 ">
											...
											<input type="text" value="{{ $data->no_dokumen }}"  class="form-control  @error('no_dokumen') is-invalid @enderror" id="no_dokumen" name="no_dokumen" >
											@error('no_dokumen')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{ $data->judul }}"  class="form-control  @error('judul') is-invalid @enderror" id="judul" name="judul" >
											@error('judul')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
