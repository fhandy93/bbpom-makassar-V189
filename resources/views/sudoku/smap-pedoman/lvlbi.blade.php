        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Revisi SMAP - Pedoman</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SUDOKU</a></li>
							<li class="breadcrumb-item active" aria-current="page">SMAP</li>
                            <li class="breadcrumb-item active" aria-current="page">Input Revisi Pedoman</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						<a href="/smap-pedoman/{{$id}}/detail-revisi"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Detail Revisi</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Input Revisi Pedoman</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/smap-pedoman/{{$id}}/input-revisi" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											<label for="klausul" class="form-label">Klausul</label>
											<input type="text" value="{{$data->klausul}}"  class="form-control  @error('klausul') is-invalid @enderror" id="klausul" name="klausul" readonly>
											@error('klausul')
									...
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											<label for="kode" class="form-label">No. Dokumen</label>
											<input type="text" value="{{$data->no_dokumen}}"  class="form-control  @error('no_dokumen') is-invalid @enderror" id="no_dokumen" name="no_dokumen" readonly>
											@error('no_dokumen')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{$data->judul}}"  class="form-control  @error('judul') is-invalid @enderror" id="judul" name="judul" readonly >
											@error('judul')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
