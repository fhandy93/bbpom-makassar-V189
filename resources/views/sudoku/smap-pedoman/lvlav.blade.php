        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data File SMAP - Pedoman</h1>
                    <div>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">SMAP - Pedoman</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item -> judul }}</td>
                                                <td>
                                                    <form method="POST" action="/smap-pedoman/{{$item -> id}}/view-file"  >
                                                        @csrf
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/smap-pedoman/{{$item -> id}}/detail-revisi"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-secondary" data-toggle="tooltip" title='Detail'><span  class="fe fe-align-justify"> Detail Revisi</span></button></a>&nbsp;
                                                        <a href="/smap-pedoman/{{$item -> id}}/edit"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-info" data-toggle="tooltip" title='Edit'><span  class="fe fe-edit"> Edit Data</span></button></a>&nbsp;
                                                        @if(checkPermission(['superadmin','laboratorium']))
                                                        <form method="POST" action="/smap-pedoman/{{ $item -> id }}/delete" style="display: inline;" >
                                                            @csrf
                ...
                @if(checkPermission(['superadmin','laboratorium']))
                <a href="/smap-pedoman/input-pedoman/"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Pedoman</button></a>
                @endif
                <p>
            </div>
        </div>
