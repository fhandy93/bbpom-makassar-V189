<x-HomeLayout>
                ...
                <div class="page-header">
                    ...
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Form Absen Dinas</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-md-2"></div>
                    	<div class="col-lg-8 col-md-8">
                    	    <form id="signupForm" method="post" class="form-horizontal" action="/adastore2">
                                @csrf
                                <div class="form-row">
    ...
    function take_snapshot() {
        Webcam.snap( function(data_uri) {
            ...
            document.getElementById('results').innerHTML = '<img src="'+data_uri+'" style="border:0; top:0px; left:0px; bottom:0px; right:0px; width:280px; height:380px;"/>';
