        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data Absen ADAJA</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">ADAJA</a></li>
                            <li class="breadcrumb-item active" aria-current="page">ADAJA View</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Data Absen Pegawai</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">Jenis Absen</th>
                                                <th class="border-bottom-0">Status</th>
                                                <th class="border-bottom-0">Jam Absen</th>
                                                <th class="border-bottom-0">Lat</th>
                                                <th class="border-bottom-0">Lon</th>
                                        ...
                                        @foreach ($adaja as $key => $item)
                                            <tr>
                                                ...
                                                <td class="align-middle text-center"><img alt="image" class="avatar avatar-md br-7" src="/storage/adaja/{{$item -> foto}}"></td>
                                                <td>
                                                    @if($item->jenis==1)
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/adaja/{{$item -> id}}/detail"><button type="button" class="btn btn-sm btn-primary">Detail</button></a>
                                                        <form method="POST" action="{{ route('category.delete', $item->id) }}" style="display: inline;" >
                                                            @csrf
                                                            <input name="_method" type="hidden" value="DELETE" hidden>
                ...
                <a href="/cetak"><button type="button" class="btn btn-primary">Download Laporan</button></a>
            </div>
        </div>
    </div>
    <!-- CONTAINER CLOSED -->
