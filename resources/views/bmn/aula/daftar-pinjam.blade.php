        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Daftar Permintaan Peminjaman AULA</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">BMN Moments</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Daftar Permintaan Peminjaman AULA</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                <div class="row row-sm">
                    ...
                    <div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/bmn/admin/peminjaman-aula/filter" >
									@csrf
									@method('post')		
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Daftar Permintaan Peminjaman AULA</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">AULA</th>
                                                <th class="border-bottom-0">Layout</th>
                                                <th class="border-bottom-0">Jumlah Peserta</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        @if($data->status == 0)
                                                        <!-- Dropdown -->
                                                        <form method="post" action="/bmn/peminjaman-aula-approve/{{$data->id}}" class="inline">
                                                        @csrf
                                                        @method('post')
                                                            <select name="status" 
                                                        ...
                                                        @endif
                                                        <!-- Tombol Delete -->
                                                        <form method="POST" action="/bmn/peminjaman-aula-delete/{{ $data->id }}" class="d-inline">
                                                            @csrf
