        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Daftar AULA Kantor</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">BMN Moments</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Daftar AULA</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Daftar AULA Kantor</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $data -> petugas }}</td>
                                                <td>{{ $data -> wa_petugas }}</td>
                                                <td><span class="avatar avatar-l brround cover-image" data-bs-image-src="{{ $data -> foto }}" style="background: url() center center;"></span></td>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <!-- Dropdown -->
                                                        <form method="post" action="/bmn/admin/update-status-aula/{{$data->id}}" class="inline">
                                                        @csrf
                                                        @method('put')
                                                            <select name="status" 
                                                                ...
                                                                <option value="2" @if($data->status==2) disabled @endif>Maintenance</option>
                                                                <option value="3" @if($data->status==3) disabled @endif>Not Available</option>
                                                            </select>
                                                            <button type="submit" class="btn btn-primary" id="update-btn-{{ $data->id }}" disabled>Update Status</button>
                                                        </form>
                                                        <a href="/bmn/admin/edit-data-aula/{{$data->id}}" class="btn btn-info"><i class="fa fa-edit me-2"></i>Edit</a>
                                                        <!-- Tombol Delete -->
                                                        @if(checkPermission(['superadmin']))
                                                            <form method="POST" action="/bmn/admin/delete-aula/{{ $data->id }}" class="d-inline">
                                                                @csrf
                ...
                <a href="/bmn/admin/input-data-aula" class="btn btn-primary">Tambah AULA</a>
            </div>
        </div>
    </div>
