                    ...
                    <div class="col-lg-12">
                            <div class="row">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="/bmn/peminjaman-mobil-filter" method="post">
                                            @csrf
                                            @method('post')
                                            <div class="row">
                                ...
                                <div class="col-xl-3 col-sm-12">
                                    <div class="card border p-0">
                                        ...
                                        <div class="card-body text-center">
                                            ...
                                            <h4 class="h4 mb-0 mt-3">{{$item->type}}</h4>
                                            <h5 class="h5 mb-0 mt-3">{{$item->nopol}}</h5><br>
                                        ...
                                        <div class="list-group">
                                                    ...
                                                    @foreach($trans as $tr)
                                                        @if($tr->car_id == $item->id )
                                                            <a href="javascript:void(0)" class="list-group-item list-group-item-action flex-column align-items-start">
                                                                <div class="d-flex w-100 justify-content-between">
                                                                    <h5 class="mb-1">@if(isset($tr->user->name)){{$tr->user->name}}@endif</h5>
                                                                    <small class="text-muted">Tgl :{{\Carbon\Carbon::parse($tr->wkt_pinjam)->format('d-m-Y')}}</small>
                                                                </div>
                                                                <div class="d-flex w-100 justify-content-between">
                                                                    <small class="text-muted">Driver : @if(isset($tr->driver->nama)){{$tr->driver->nama}}@else-@endif</small>
                                            ...
                                            @if($item->status == 1 || $item->status == 2) 
                                                <a href="/bmn/peminjaman-mobil/{{$item->id}}" class="btn btn-primary btn-sm ">Ajukan Peminjaman</a> 
                                            @else 
