        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Driver</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">BMN</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Input Driver</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <a href="/bmn/admin/daftar-driver"><button type="button" class="btn btn-primary"><i class="fa fa-arrow-left me-2"></i>Back</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Input Driver</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/bmn/admin/input-driver-store" >
									@csrf
									@method('post')
									<div class="form-row">
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="+62"  class="form-control  @error('stok') is-invalid @enderror" id="wa" name="wa" >
											@error('wa')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Tambah Driver</button>
									</div>
