				...
				<div class="row">
                    ...
                    <a href="/bmn/admin/daftar-kendaraan"><button type="button" class="btn btn-primary"><i class="fa fa-arrow-left me-2"></i>Back</button></a><p>
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/bmn/admin/update-kendaraan-store/{{$data->id}}" >
									@csrf
									@method('put')
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="merek" class="form-label">Merek Kendaraan</label>
											<input type="text" value="{{$data->merek}}"  class="form-control  @error('merek') is-invalid @enderror" id="merek" name="merek" readonly>
											@error('merek')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{$data->type}}"  class="form-control  @error('type') is-invalid @enderror" id="type" name="type" readonly>
											@error('type')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<input type="text" value="{{$data->nopol}}"  class="form-control  @error('nopol') is-invalid @enderror" id="nopol" name="nopol">
											@error('nopol')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
