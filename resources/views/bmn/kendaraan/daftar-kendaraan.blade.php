        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Daftar Kendaraan Dinas Kantor</h1>
                    <div>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Daftar Kendaraan Dinas Kantor</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">NOPOL</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <!-- Dropdown -->
                                                        <form method="post" action="/bmn/admin/update-status-kendaraan/{{$data->id}}" class="inline">
                                                        @csrf
                                                        @method('put')
                                                            <select name="status" 
                                                        ...
                                                        <a href="/bmn/admin/edit-data-kendaraan/{{$data->id}}" class="btn btn-info"><i class="fa fa-edit me-2"></i>Edit</a>
                                                        <!-- Tombol Delete -->
                                                        @if(checkPermission(['superadmin']))
                                                            <form method="POST" action="/bmn/admin/delete-kendaraan/{{ $data->id }}" class="d-inline">
                                                                @csrf
                ...
                <a href="/bmn/admin/input-data-kendaraan" class="btn btn-primary">Tambah Kendaraan</a>
            </div>
        </div>
    </div>
