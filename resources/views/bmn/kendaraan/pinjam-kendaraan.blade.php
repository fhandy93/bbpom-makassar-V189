        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Form Peminjaman Kendaraan</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">BMN Moments</a></li>
							<li class="breadcrumb-item active" aria-current="page">Peminjaman Kendaraan</li>
                            <li class="breadcrumb-item active" aria-current="page">Form Peminjaman Kendaraan</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						<a href="/bmn/pinjam-kendaraan"><button type="button" class="btn btn-primary"><i class="fa fa-arrow-left me-2"></i>Back</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Peminjaman Kendaraan</h3>
							</div>
							<div class="card-body">
                            <form id="signupForm" method="post" class="form-horizontal" action="/bmn/peminjaman-kendaraan-store/{{$car->id}}" >
									@csrf
									@method('post')
                                   
                                        <div class="card-body text-center">
                                            <h4 class="h4 mb-0 mt-3">{{$car->merek}}</h4>
                                            <span class="avatar avatar-xxl cover-image" data-bs-image-src="{{ $car->foto }}" style="background: url() center center;"></span>
                                            <h4 class="h4 mb-0 mt-3">{{$car->type}}</h4>
                                            <h5 class="h5 mb-0 mt-3">{{$car->nopol}}</h5><br> 
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-8 mb-12">
                                                ...
                                                <select name="driver" class="form-control form-select select2" id="driver">
                                                    <option value="" selected disabled>Pilih Nama Driver ...</option>
                                                    ...
                                                    @endforeach
                                                    <!-- <option value="100" data-status="{{ $item->status }}">-->
                                                    <!--    Peminjaman Tanpa Driver-->
                                                    <!--</option>-->
                                                </select>
                                                @error('driver')
                                                    <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="form-row">
                                            <div class="col-xl-12 mb-12 ">
                                                <label for="perlu" class="form-label">Keperluan</label>
