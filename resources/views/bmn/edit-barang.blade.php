				...
				<div class="row">
                    ...
                    <a href="/bmn/admin/daftar-barang"><button type="button" class="btn btn-primary"><i class="fa fa-arrow-left me-2"></i>Back</button></a><p>
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/bmn/admin/update-barang-store/{{$data->id}}" >
									@csrf
									@method('put')
									...
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<input type="text" value="{{$data->kd_satker}}"  class="form-control  @error('satker') is-invalid @enderror" id="satker" name="satker" readonly>
											@error('satker')
									...
									<div class="form-row">
										<div class="col-xl-5 mb-12 ">
											...
											<input type="text" value="{{$data->kode}}"  class="form-control  @error('kode') is-invalid @enderror" id="kode" name="kode" readonly>
											@error('kode')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-4 mb-12 ">
											...
											<input type="number" value="{{$data->nup  }}"  class="form-control  @error('nup') is-invalid @enderror" id="nup" name="nup" readonly>
											@error('nup')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											...
											<input type="text" value="{{$data->nm_barang}}"  class="form-control  @error('nama') is-invalid @enderror" id="nama" name="nama">
											@error('nama')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											...
											<input type="text" value="{{$data->merek}}"  class="form-control  @error('merek') is-invalid @enderror" id="merek" name="merek" >
											@error('merek')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<option value="2" {{$data->kondisi == 2 ? 'selected' : ''}}>Rusak Ringan</option>
											<option value="3" {{$data->kondisi == 3 ? 'selected' : ''}}>Rusak Berat</option>
										</select>
										@error('kondisi')
									...
									<div class="form-row">
										<div class="col-xl-5 mb-12 ">
											...
											<div class="input-group">
												...
												<input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" value="{{date('d/m/Y', strtotime($data->tgl_perolehan)) }}" type="text" name="tgl" id="tgl">
											</div>
											@error('tgl')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<select name="lokasi" class="form-control form-select select2" style="width: 100%;" >
												...
												<option value="{{$item->id}}" {{$data->lokasi == $item->id ? 'selected' : ''}}>{{$item->nm_ruangan}}</option>
												@endforeach
											</select>	
											@error('lokasi')
											<span style="color:#e23e3d;"> {{ $message }} </span>
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{$data->nilai}}"  class="form-control  @error('nilai') is-invalid @enderror" id="nilai" name="nilai" placeholder="Contoh : 1000000 (Tanpa Tanda Baca Titik)">
											@error('nilai')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Update Barang</button>
									</div>
