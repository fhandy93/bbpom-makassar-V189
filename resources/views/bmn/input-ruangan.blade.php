        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Ruangan</h1>
                    <div>
                        <ol class="breadcrumb">
				...
				<div class="row">
                    ...
                    <a href="/bmn/admin/daftar-ruangan"><button type="button" class="btn btn-primary"><i class="fa fa-arrow-left me-2"></i>Back</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Input Ruangan</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/bmn/admin/input-ruangan-store" >
									@csrf
									@method('post')
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="id" class="form-label">Nama Ruangan</label>
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value=""  class="form-control  @error('pj') is-invalid @enderror" id="pj" name="pj" >
											@error('pj')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Tambah Ruangan</button>
									</div>
	...
	setTimeout(function() {
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
                    nama: {
						required: "Kolom Nama ruangan harus diisi"
					},			
                    pj :{
                        required:"Kolom PJ ruangan harus diisi"
                    }
                },
				errorElement: "em",
