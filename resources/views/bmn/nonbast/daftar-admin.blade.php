            ...
            <div class="main-container container-fluid">
                ...
                <div class="row row-sm">
                    ...
                    <div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/bmn/admin/pinjam-non-bast/filter" >
									@csrf
									@method('post')		
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @if(checkPermission(['perlengkapan'])  || checkPermission(['superadmin']) ) 
                                                        
                                                    <form method="POST" action="/bmn/admin/delete-pinjam-non-bast/{{ $data->id }}" class="d-inline">
                                                        @csrf
