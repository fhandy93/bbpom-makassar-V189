        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Daftar Barang Kantor</h1>
                    <div>
                        <ol class="breadcrumb">
                ...
                <div class="row row-sm">
                    ...
                    <div class="card">
							<div class="card-header">
								<h3 class="card-title">Filter Data (Kode/Nama Barang)</h3>
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/bmn/admin/daftar-barang/filter" >
									@csrf
									@method('post')		
                                    ...
                                    <div class="form-group m-0">
                                            <div class="row ">
                                                ...
                                                <div class="col-9">
                                                    <input type="text" class="form-control  @error('no_surat') is-invalid @enderror" name="fil" id="fil" placeholder="Contoh : 2010104001, Laptop, dll">
                                                </div>
                                                <div class="col-3">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Daftar Barang Kantor</h3>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <!-- Dropdown -->
                                                        <a href="/bmn/admin/detail-barang/{{$barang->id}}" class="btn btn-sm btn-success"><i class="fa fa-eye me-2"></i>Detail</a>
                                                        <a href="/bmn/admin/edit-data-barang/{{$barang->id}}" class="btn btn-sm btn-info"><i class="fa fa-edit me-2"></i>Edit</a>
                                                        <!-- Tombol Delete -->
                                                        @if(checkPermission(['superadmin']))
                                                            <form method="POST" action="/bmn/admin/delete-barang/{{ $barang->id }}" class="d-inline">
                                                                @csrf
                ...
                <a href="/bmn/admin/input-data-barang" class="btn btn-primary">Tambah Barang</a>
            </div>
        </div>
    </div>
