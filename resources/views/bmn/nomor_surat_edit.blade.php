	...
	<div class="main-content app-content mt-0">
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <h1 class="page-title">Edit Nomor Surat BAST</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">BMN Moments</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Nomor Surat</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
					...
					<div class="col-lg-8 col-md-8">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Edit Nomor Surat</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/bmn/bast-pengembalian-nomor-update/{{$id}}" >
									@csrf
									@method('put')			
                                    <div class="form-row">
										<div class="col-xl-12 mb-12 ">
											<label for="no_surat" class="form-label">Nomor Surat</label>
											<input type="text"  id="no_surat" class="form-control  @error('no_surat') is-invalid @enderror" name="no_surat" value="{{$data->no_surat}}">
											@error('no_surat')
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:160px;">Update Nomor Surat</button>
