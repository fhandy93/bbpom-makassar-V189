    ...
    <div class="main-content app-content mt-0">
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/bmn/bast-pengembalian-detail/{{$data ->id}}" class="btn btn-success btn-sm"><i class="fa fa-eye me-2"></i>Detail</a>
                                                    @if($data -> status == 0  || checkPermission(['superadmin']) ) 
                                                        @if($data -> status == 0)
                                                        <a href="{{ $jns == 1 ? '/bmn/bast-pengembalian-edit/'.$data ->id : '/bmn/bast-peminjaman-edit/'.$data ->id }}" class="btn btn-primary btn-sm"><i class="fa fa-edit me-2"></i>Edit</a>
                                                        @endif
                ...
                <a href="{{ $jns == 1 ? '/bmn/bast-pengembalian-input' : '/bmn/bast-peminjaman-input' }}"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Buat laporan</button></a>
            </div>
        </div>
    </div>
