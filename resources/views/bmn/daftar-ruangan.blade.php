        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Daftar Ruangan Kantor</h1>
                    <div>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Daftar Ruangan Kantor</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">Penanggung Jawab Ruangan</th>
                ...
                <a href="/bmn/admin/input-data-ruangan" class="btn btn-primary">Tambah Ruangan</a>
            </div>
        </div>
    </div>
