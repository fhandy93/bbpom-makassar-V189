				...
				<div class="row">
                    ...
                    <a href="/bmn/admin/daftar-ruangan"><button type="button" class="btn btn-primary"><i class="fa fa-arrow-left me-2"></i>Back</button></a><p>
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/bmn/admin/update-ruangan-store/{{$data->id}}" >
									@csrf
									@method('put')
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="id" class="form-label">Nama Ruangan</label>
											<input type="text" value="{{$data->nm_ruangan}}"  class="form-control  @error('nama') is-invalid @enderror" id="nama" name="nama">
											@error('nama')
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Update Ruangan</button>
									</div>
