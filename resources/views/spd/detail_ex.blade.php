                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                               ...
                                               <tr>
                                                ...
                                                <!-- <td>: @if(isset($data->tgl_berangkat2)) {{ rangeDay($data->tgl_berangkat, $data->tgl_kembali) + rangeDay($data->tgl_berangkat2, $data->tgl_kembali2) }} 
                                                        @elseif(isset($data->tgl_berangkat3)) {{rangeDay($data->tgl_berangkat, $data->tgl_kembali) + rangeDay($data->tgl_berangkat2, $data->tgl_kembali2) + rangeDay($data->tgl_berangkat3, $data->tgl_kembali3) }} 
                                                        @elseif(isset($data->tgl_berangkat4)) {{rangeDay($data->tgl_berangkat, $data->tgl_kembali) + rangeDay($data->tgl_berangkat2, $data->tgl_kembali2) + rangeDay($data->tgl_berangkat3, $data->tgl_kembali3) + rangeDay($data->tgl_berangkat4, $data->tgl_kembali4) }} 
                                                        @else {{rangeDay($data->tgl_berangkat, $data->tgl_kembali)}}
                                                        @endif  Hari</td> -->
                                            </tr>
                                            <tr>
                                                <td>13</td>
                        ...
                        <table>
                            <tr>
                                ...
                                <!-- menu -->
                                    ...
                                    @if($data->status==1)
                                    <a href="/sppd-edit-external/{{$data ->id}}" class="btn btn-primary "><i class="fa fa-edit me-2"></i>Edit Data</a>
                                    
                                    <form method="POST" action="/sppd-kirim-external/{{$data ->id}}" class="d-inline">
                                        @csrf
                                    ...
                                    @if(checkPermission(['superadmin','admin']))
                                        @if($data->status==2)
                                        <a href="/sppd-approved-external/{{$data ->id}}" class="btn btn-success "><i class="fa fa-check me-2"></i>Konfirmasi</a>
                                        <a href="/sppd-edit-external/{{$data ->id}}" class="btn btn-primary "><i class="fa fa-edit me-2"></i>Edit Data</a>    
                                        @endif 
                                        @if($data->status==3)
                                        <a href="/sppd-cetak-external/{{$data ->id}}" class="btn btn-info"><i class="fa fa-print me-2"></i>Cetak SPPD</a>
                                            @if($data->no_sppd==null)
                                            <a href="/sppd-nomor-add-external/{{$data ->id}}" class="btn btn-primary"><i class="fa fa-edit me-2"></i>Input Nomor SPPD</a>
                                            @endif
                                            @if($data->no_sppd!=null)
                                            <a href="/sppd-nomor-edit-external/{{$data ->id}}" class="btn btn-primary"><i class="fa fa-edit me-2"></i>Edit Nomor SPPD</a>
                                            @endif
                                        @endif   
                                    @endif
                                </td>
