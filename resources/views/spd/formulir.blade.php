				...
				<div class="row">
					...
					<div class="col-lg-10 col-md-10">
						...
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/sppd-store" enctype="multipart/form-data">
									@csrf
									@method('post')

									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="user_data" class="form-label">Nama Pegawai (Pegawai 1)</label>
											<select name="user_data" class="form-control form-select select2"  onchange="showDetail(this.value)">
									...
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<input type="text"  id="nip" class="form-control  @error('nip') is-invalid @enderror" name="nip" readonly>
											@error('nip')
									...
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<input type="text"  id="pangkat" class="form-control  @error('pangkat') is-invalid @enderror" name="pangkat" readonly>
											@error('pangkat')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-10 mb-12 ">
											...
											<input type="text"  id="jabatan" class="form-control  @error('jabatan') is-invalid @enderror" name="jabatan" readonly>
											@error('jabatan')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-group">
										<label for="tag">Tambahan Peserta Perjalanan Dinas (Pegawai 2,3,...)</label><br>
										<span class="text-warning"><b>*Fitur ini digunakan HANYA JIKA terdapat lebih dari 1 nama pegawai dalam surat tugas yang akan melaksanakan perjalanan dinas</b></span><br>
										<span class="text-warning"><b>*Pegawai yang disebutkan namanya hanya boleh pegawai yang ada dalam 1 surat tugas yang sama </b></span><br>
										<span class="text-warning"><b>*Sebelum menggunakan fitur ini agar memastikan pegawai yang akan disebutkan namanya telah melengkapi data Profil nya (NIP, Pangkat, Jabatan)</b></span><br>
										<span class="text-warning"><b>*Untuk memeriksa kelengkapan profil Pegawai yang akan disebutkan dapat dilakukan pada menu <a class="text-success" href="https://bbpom-makassar.com/userl">User List</a> kemudian klik username dari Pegawai </b></span>
                                    ...
                                    <br>
										<div class="card">
											...
											<div class="card-body">
												<span class="text-warning">* Diisi hanya jika diperlukan</span><br>
												<br>
												<div class="card">
													<div class="card-header">
									...
									<div class="form-row">
										<div class="form-group col-xl-6 mb-12 ">
											...
											<span class="text-warning">* Diisi hanya jika diperlukan</span><br>
											<span class="text-warning">* Pengikut yang diisi hanya mengikut di Pegawai 1</span> 
										</div>
									</div>
									<div class="form-row">
