...
<div id="wrapper">
        ...
        <table id="table2" style="width: 715px; " >
            <tr>
            ...
            <tr>
                ...
                <td colspan="2"><div style="margin-left: 5px; padding: 4px; line-height: 2;">: {{$data->userdata->name}}<br>: {{$prof->nip}}</div></td>
            </tr>
            <tr>
                ...
                <td colspan="2"><div style="margin-left: 5px; padding: 4px; line-height: 2;">a. {{$prof->pangkat}}<br>b. {{$prof->jabatan}}<br>c. @if($data->level_biaya == 1) A @elseif($data->level_biaya == 2) B @elseif($data->level_biaya == 3) C @endif
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-left-style: none;width: 180px;"><div style="text-align: left;">Tanggal @if(isset($data->tgl_st)){{ $data->tgl_st->isoFormat('D MMMM Y')}}@endif</div></td>
            </tr>
        </table>
        <p>
        ...
        <table id="table4" style="margin-top: 50px; width: 700px;" >
            ...
            <tr>
                ...
                <td colspan="3" style="border-top-style: none;">
                    ...
                    @elseif($data->mengetahui==3)
                        NIP.19810505200501 1 003
                    @elseif($data->mengetahui==4)
                        NIP.19670509199302 1 001
                    @elseif($data->mengetahui==5)
                        NIP.19740320199403 2 001 
                    @elseif($data->mengetahui==6)
                        NIP.19790123200501 1 001
                    @elseif($data->mengetahui==7)
                        NIP.19721022199403 1 001 
                    @elseif($data->mengetahui==8)
                        NIP.19780209200501 1 002
                    @elseif($data->mengetahui==9)
                        NIP.NIP.19670509199302 1 001
                    @elseif($data->mengetahui==10)
                        NIP.19671005199803 2 001 
                    @elseif($data->mengetahui==11)
                        NIP.19681027199803 2 001
                    @elseif($data->mengetahui==12)
                        NIP.19790124200501 2 001
                    @elseif($data->mengetahui==13)
                        NIP.19801027200501 2 001
                    @elseif($data->mengetahui==14)
                        NIP.19780725200312 2 001
                    @endif
                </td>
