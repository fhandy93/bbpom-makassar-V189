				...
				<div class="row">
					...
					<div class="col-lg-10 col-md-10">
						...
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/sppd-update/{{$data->id}}" enctype="multipart/form-data">
									@csrf
									@method('put')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text"  value="{{$user->name}}" id="user_data" class="form-control  @error('nip') is-invalid @enderror" name="user_data" readonly>
										</div>
									</div>
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											<label for="nip" class="form-label">NIP</label>
											<input type="text" value="{{$prof->nip }}" id="nip" class="form-control  @error('nip') is-invalid @enderror" name="nip" readonly>
											@error('nip')
									...
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<input type="text" value="{{$prof->pangkat}}" id="pangkat" class="form-control  @error('pangkat') is-invalid @enderror" name="pangkat" readonly>
											@error('pangkat')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-10 mb-12 ">
											...
											<input type="text" value="{{$prof->jabatan}}" id="jabatan" class="form-control  @error('jabatan') is-invalid @enderror" name="jabatan" readonly>
											@error('jabatan')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
