        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Form Verifikasi Lembur</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SMILE</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Form Verifikasi Lembur</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<a href="/smile" class="btn btn-primary my-3"><i class="fa fa-arrow-left me-2"></i>Kembali</a>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Verifikasi Lembur</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/smile-verified/{{$id}}" enctype="multipart/form-data">
									@csrf
									@method('put')
									
                                    <div class="form-row">
										<div class="col-xl-8 mb-12 ">
											<label for="ket" class="form-label">Keterangan Lembur</label>
											<textarea  class="form-control  @error('ket') is-invalid @enderror" id="ket" name="ket"  rows="4">{{old('ket')}}</textarea>
											@error('ket')
											<span style="color: red; font-size: 8;"> Keterangan Lembur harus diisi </span>
											@enderror	
										</div>
									</div><p>
									...
									<div class="row ">
                                        ...
                                        <label for="tugas" class="form-label">File Pendukung</label>
                                            <input type="file" class="dropify" data-bs-height="180" id="file" name="file" />
                                        </div>
                                        @error('file')
                                            <span style="color: red;"> {{ $message }} </span>
                                        @enderror
                                        <span><b style="color: yellow;">*File Pendukung harus berjenis Dokumen:pdf atau Gambar:jpeg,png,jpg. </b></span>	   
                                    </div>
	...
	setTimeout(function() {
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
					ket: {
						required: "Keterangan lembur harus diisi",
