				...
				<div class="row">
					...
					<a href="/smile-detail/{{$id}}" class="btn btn-primary my-3"><i class="fa fa-arrow-left me-2"></i>Kembali</a>
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/smile-absen-store/{{$id}}/{{$lembur_id}}" enctype="multipart/form-data">
									@csrf
									@method('post')
                                    ...
                                    <div class="form-row">
                                        <div class="col-xl-4 mb-12 ">
											...
											<div class="input-group">
												...
												<input class="form-control fc-datepicker" value="{{date('d/m/Y')}}" placeholder="MM/DD/YYYY" type="text" name="tgl_lembur" id="tgl_lembur">
											</div>
											@error('tgl_lembur')
	...
	setTimeout(function() {
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
					absen: {
						required: "Bukti Absen harus diisi",
