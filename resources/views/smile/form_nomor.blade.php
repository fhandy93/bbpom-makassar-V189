				...
				<div class="row">
					...
					<a href="/smile-detail/{{$id}}" class="btn btn-primary my-3"><i class="fa fa-arrow-left me-2"></i>Kembali</a>
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/smile-no-spml/{{$id}}" >
									@csrf
									@method('put')
									...
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											...
											<input type="type" value="{{old('no_surat')}}"  class="form-control  @error('no_surat') is-invalid @enderror" id="no_surat" name="no_surat" >
											@error('no_surat')
