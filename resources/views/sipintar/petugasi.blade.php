        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Petugas</h1>
                    <div>
                        <ol class="breadcrumb">
					...
					<div class="col-lg-8 col-md-8">
						...
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Input Petugas Pelayanan Publik</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" enctype="multipart/form-data" class="form-horizontal" action="/sipintar/petugas-store" >
									@csrf
									@method('post')
									...
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{old('nip')}}"  class="form-control  @error('nip') is-invalid @enderror " id="nip" name="nip" >
											@error('nip')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row" id="sertifikat"  >
                                        <div class="col-xl-8 mb-12 ">
                                            <div class="form-group">
												...
												<span class="invalid-feedback"> {{ $message }} </span>
												@enderror<p>	
                                                <span style="color:yellow">* File harus berextensi jpg,png,jpeg</span>
                                            </div>
                                        </div>
                                    </div>
									<p>
		...
		$( document ).ready( function () {
			$( "#signupForm" ).validate( {
				...
				messages: {
					...
					file: {
						required: "File Foto Upload harus diisi"
					},
					nip: {
