    ...
    <div class="main-content app-content mt-0">
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    ...
                    <div>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Petugas View</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Petugas Pelayanan Publik</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$data -> nama}}</td>
                                                    <td>{{$data -> nip}}</td>   
                                                    <td><img alt="image" style="width: 400px;" src="{{$data -> foto}}"></td>
                                                    <td>
                                                        <div class="btn-list">
                                                            <a href="/sipintar/data-tamu/{{$data->id}}/edit"><button type="button" style="margin-right: 5px;" class="btn btn-sm btn-primary"><span  class="fe fe-edit"> Edit</span></button></a>&nbsp;
                                                            <form method="POST" action="/sipintar/data-petugas/{{$data->id}}/delete" style="display: inline;" >
                                                                @csrf
                ...
                <a href="/sipintar/petugas-input"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Petugas</button></a>
                <p>
            </div>
        </div>
    </div>
