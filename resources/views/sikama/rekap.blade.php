        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Rekapitulasi Izin Pegawai</h1>
                    <div>
                        <ol class="breadcrumb">
                ...
                <div class="row row-sm">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/rekap-izin/filter" >
									@csrf
									@method('post')		
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Rekapitulasi Daftar Izin Pegawai</h3>
                            </div>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <span class="badge rounded-pill bg-success">Izin Selesai</span></td>
                                                     @elseif($izin -> status == 6 )
                                                    <span class="badge rounded-pill bg-success">Izin Dibatalkan</span></td>
                                                    @endif
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    @if($izin -> status == 1)   
                                                        <a href="/konfizin/{{$izin -> id}}"><button type="button"  class="btn btn-sm btn-primary"><i class="fa fa-bars" aria-hidden="true"></i> Konfirmasi</button></a>
                                                    @endif
                                                    @if($izin -> status == 2 || $izin -> status == 5)  
                                                    <a href="/cetakizin/{{$izin -> id}}"><button type="button"  class="btn btn-sm btn-secondary"><i class="fa fa-print me-2"></i>Cetak SK</button></a>
                                                    @endif
                                                    <form method="POST" action="konfir/{{ $izin -> id }}" style="display: inline;" >
                                                            @csrf
                                                            <input name="_method" type="hidden" value="DELETE">
                                                            <button type="submit" class="btn btn-sm btn-danger" data-toggle="tooltip" title='Delete'><i class="fa fa-trash me-2"></i>Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            @endforeach
