        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data Link BerAKHLAK</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">{{getMenuBerakhlak($id)}}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Link View</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/{{$url}}/link-detail/{{$item->id}}/" class="btn btn-success btn-sm"><i class="fa fa-eye"> Detail</i></a> &nbsp;
                                                    <form method="POST" action="/berakhlak-link/delete/{{$item->id }}" style="display: inline;" >
                                                        @csrf
                ...
                <a href="/{{$url}}/link-input"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah</button></a>
