        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Update Image BerAKLAK</h1>
                    <div>
                        <ol class="breadcrumb">
					...
					<a href="/{{$url}}/image" class="btn btn-primary my-3"><i class="fa fa-arrow-left me-2"></i>Kembali</a>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Update Image</h3>
							</div>
							<div class="card-body">
                                
								<form id="signupForm" method="post" class="form-horizontal" action="/image-edit-store/{{$idn}}" enctype="multipart/form-data">
									@csrf
									@method('post')
                                    <div class="form-row">
