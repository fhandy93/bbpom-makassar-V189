        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Image BerAKLAK</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">{{getMenuBerakhlak($idn)}}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Image Input</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<a href="/{{$url}}/image" class="btn btn-primary my-3"><i class="fa fa-arrow-left me-2"></i>Kembali</a>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Input Image {{getMenuBerakhlak($idn)}}</h3>
							</div>
							<div class="card-body">
                                
								<form id="signupForm" method="post" class="form-horizontal" action="/image-store/{{$idn}}" enctype="multipart/form-data">
									@csrf
									@method('post')
                                    <div class="form-row">
									...
									<div class="row ">
                                        ...
                                        @enderror
                                        <span><b style="color: yellow;">*File format:jpeg,png,jpg. </b></span>	   
                                    </div>
			...
			$( "#signupForm" ).validate( {
				...
				messages: {
					file: {
						...
						extension: "Hanya menerima file dengan extensi jpg, jpeg, png"
					},
                    judul: {
						required: "Judul Image upload harus diisi",
					}
