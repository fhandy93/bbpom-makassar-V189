        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input File BerAKLAK</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">{{getMenuBerakhlak($idn)}}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">File Input</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<a href="/{{$url}}/file" class="btn btn-primary my-3"><i class="fa fa-arrow-left me-2"></i>Kembali</a>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Input File {{getMenuBerakhlak($idn)}}</h3>
							</div>
							<div class="card-body">
                                
								<form id="signupForm" method="post" class="form-horizontal" action="/file-store/{{$idn}}" enctype="multipart/form-data">
									@csrf
									@method('post')
                                    <div class="form-row">
                                    ...
                                    <!-- <input type="text" value="{{$idn}}"   id="id" name="id" hidden > -->
									...
									<div class="row ">
                                        ...
                                        @enderror
                                        <span><b style="color: yellow;">*File format: pdf, xlsx, docx, pptx. </b></span>	   
                                    </div>
			...
			$( "#signupForm" ).validate( {
				...
				messages: {
					file: {
						...
						extension: "Hanya menerima file dengan extensi pdf, xlsx, docx, pptx"
					}, 
                    judul: {
						required: "Judul File upload harus diisi",
					}
