        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Video BerAKLAK</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">{{getMenuBerakhlak($idn)}}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Video Input</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
					...
					<a href="/{{$url}}/video" class="btn btn-primary my-3"><i class="fa fa-arrow-left me-2"></i>Kembali</a>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Input Video {{getMenuBerakhlak($idn)}}</h3>
							</div>
							<div class="card-body">
                                
								<form id="signupForm" method="post" class="form-horizontal" action="/video-store/{{$idn}}">
									@csrf
									@method('post')
                                    <div class="form-row">
                                    ...
                                    <div class="form-row">
										<div class="col-xl-6 mb-12 ">
											<label for="link" class="form-label">Link Video Embed</label>
