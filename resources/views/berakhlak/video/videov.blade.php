        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data Video BerAKHLAK</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">{{getMenuBerakhlak($id)}}</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Video View</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">{{ getMenuBerakhlak($id) }}</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/{{$url}}/video-detail/{{$item->id}}/" class="btn btn-success btn-sm"><i class="fa fa-eye"> Detail</i></a> &nbsp;
                                                    <form method="POST" action="/berakhlak-video/delete/{{$item->id }}" style="display: inline;" >
                                                        @csrf
                                                        <input name="_method" type="hidden" value="DELETE">
                                                        <button type="submit" class="btn btn-sm btn-danger btn-flat show_confirm" data-toggle="tooltip" title='Delete'><i class="fa fa-trash"> Delete</i></button>
                                                    </form>
                                                </td>
                                            </tr>
                                            @endforeach
                ...
                <a href="/{{$url}}/video-input"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah</button></a>
