        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data Users SAPPAI</h1>
                    <div>
                        <ol class="breadcrumb">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/sample_detail/{{$user -> id}}"><button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title='Detail Sample'><span  class="fe fe-eye"> </span></button></a>&nbsp;
                                                        <form method="POST" action="/user_sappai/delete/{{$user->id }}" style="display: inline;" >
                                                            @csrf
                ...
                <a href="/useri_sappai"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah User</button></a>
            </div>
        </div>
    </div>
    <!-- CONTAINER CLOSED -->
