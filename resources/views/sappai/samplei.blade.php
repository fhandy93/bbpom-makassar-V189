				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						...
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/sample_store" enctype="multipart/form-data">
									@csrf
									@method('post')
                                    <div class="form-row">
										<div class="form-group col-xl-8 mb-12 ">
											<label class="form-label">User </label>
											<select name="user" class="form-control form-select select2" data-bs-placeholder="Pilih User">
									...
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<input type="text" value="{{old('kode')}}"  class="form-control  @error('kode') is-invalid @enderror" id="kode" name="kode" >
											@error('nama')
									...
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<div class="input-group">
												...
												<input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" value="00/00/0000" type="text" name="tgl_masuk" id="tgl_masuk">
											</div>
											@error('tgl_masuk')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
                                    ...
                                    <div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<input type="text" value="{{old('komoditi')}}"  class="form-control  @error('komoditi') is-invalid @enderror" id="komoditi" name="komoditi" >
											@error('komoditi')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
                                    ...
                                    <div class="form-row">
										<div class="col-xl-12 mb-12 ">
											...
											<input type="text" value="{{old('asal')}}"  class="form-control  @error('asal') is-invalid @enderror" id="asal" name="asal" >
											@error('asal')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
                                    ...
                                    <div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<input type="text" value="{{old('billing')}}"  class="form-control  @error('billing') is-invalid @enderror" id="billing" name="billing" >
											@error('billing')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
                                    ...
                                    <div class="form-row" id="sertifikat" style="display: none;">
                                        <div class="col-xl-8 mb-12 ">
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Tambah Sample</button>
