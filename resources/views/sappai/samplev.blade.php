        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data Sample SAPPAI</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Sample</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Sample View</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="border-bottom-0">Kode Sample</th>
                                                <th class="border-bottom-0">Tanggal Masuk Sample</th>
                                                <th class="border-bottom-0">Nama Sample</th>
                                                <th class="border-bottom-0">Komoditi</th>
                                                <th class="border-bottom-0">Asal Sample</th>
                                                <th class="border-bottom-0">Tahap</th>
                                                <th class="border-bottom-0">Kode Billing</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$item -> kode}}</td>
                                                <td>{{$item -> tanggal}}</td>
                                                <td>{{$item -> nama_sample}}</td>
                                                <td>{{$item -> komoditi}}</td>
                                                <td>{{$item -> asal}}</td>
                                               
                                                @if ($item -> tahap == 1)
                                                    <td>Sampel Dalam Proses Administrasi</td>
                                                @elseif ($item -> tahap == 2)
                                                    <td>Sampel Dalam Proses Pengujian</td>
                                                @elseif ($item -> tahap == 3)
                                                    <td>Sampel Selesai Diuji</td>
                                                @elseif ($item -> tahap == 4)
                                                    <td>Pengambilan Sertifikat Hasil Uji</td>
                                                @endif
                                                ...
                                                <td>
                                                    <div class="btn-list">
                                                    <a href="/sample_sappai/{{$item -> id}}/edit"><button type="button" class="btn btn-sm btn-primary" data-toggle="tooltip" title='Edit'><span  class="fe fe-edit"> </span></button></a>&nbsp;
                                                        <form method="POST" action="/sample_sappai/delete/{{$item->id }}" style="display: inline;" >
                                                            @csrf
                ...
                <a href="/samplei_sappai"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Sample</button></a>
            </div>
        </div>
    </div>
    <!-- CONTAINER CLOSED -->
