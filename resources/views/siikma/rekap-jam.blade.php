        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Rekapitulasi Total Jam Izin Pegawai</h1>
                    <div>
                        <ol class="breadcrumb">
                ...
                <div class="row row-sm">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/siikma/rekap-izin-jam/filter" >
									@csrf
									@method('post')		
                          ...
                          <a href="/siikma/rekap-data"><button type="button" class="btn btn-success"><i class="fa fa-check me-2"></i>Rekap Data Pegawai</button></a><p>
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Rekapitulasi Total Jam Izin Pegawai</h3>
                            </div>
                            <div class="card-body">
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        <thead>
                                            ...
                                            <th class="border-bottom-0">Index</th>
                                                ...
                                                <th class="border-bottom-0">Total Jam Izin</th>
                                                <!-- <th>Action</th> -->
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $izin -> total_jam}}</td>
                                                <!-- <td>
                                                    <a href="/siikma/daftar-izin-rekap-individu" class="btn btn-primary"><i class="fa fa-eye"></i>  Tampilkan Daftar Izin</a>
                                                </td> -->
