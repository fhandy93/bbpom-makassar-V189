				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						...
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/updateulpkk/{{ $ulpk->id }}" >
									@csrf
									@method('put')
									<div class="form-row">
										<div class="form-group col-xl-6 mb-12 ">
											...
											<select name="jenis" class="form-control form-select select2" data-bs-placeholder="Select Country">
                                                   @if( $ulpk->jenis == "Informasi" )
													...
													@elseif( $ulpk->jenis == "Pengaduan" )
                                                    <option value="Informasi">Informasi</option>
													<option value="Pengaduan" selected>Pengaduan</option>
													<option value="SKI">SKI</option>
													<option value="SKE">SKE</option>
													<option value="Pengujian">Pengujian</option>
													@elseif( $ulpk->jenis == "SKI" )
                                                    <option value="Informasi">Informasi</option>
													<option value="Pengaduan">Pengaduan</option>
													<option value="SKI" selected>SKI</option>
													<option value="SKE">SKE</option>
													<option value="Pengujian">Pengujian</option>
													@elseif( $ulpk->jenis == "SKE" )
                                                    <option value="Informasi">Informasi</option>
													<option value="Pengaduan">Pengaduan</option>
													<option value="SKI">SKI</option>
													<option value="SKE" selected>SKE</option>
													<option value="Pengujian">Pengujian</option>
                                                    @else
                                                    <option value="Informasi">Informasi</option>
													<option value="Pengaduan">Pengaduan</option>
													<option value="SKI">SKI</option>
													<option value="Pengaduan">SKE</option>
													<option value="Pengujian"  selected>Pengujian</option>
                                                    @endif
											</select>
										</div>
									</div>
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											...
											<textarea  class="ckeditor form-control  @error('layanan') is-invalid @enderror" id="layanan" name="layanan"  rows="4">{{ $ulpk->layanan }}</textarea>
											@error('layanan')
									...
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											...
											<textarea  class="ckeditor form-control  @error('jawaban') is-invalid @enderror" id="jawaban" name="jawaban"  rows="4">{{ $ulpk->jawaban }}</textarea>
											@error('jawaban')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="form-group col-xl-6 mb-12 ">
											...
											<select name="komoditi" class="form-control form-select select2" data-bs-placeholder="Select Country">
													@if( $ulpk->komoditi == "Obat" )
                                                    <option value="Obat" selected>Obat</option>
													<option value="Obat Tradisional">Obat Tradisional</option>
													<option value="Pangan">Pangan</option>
													<option value="Kosmetik">Kosmetik</option>
													<option value="Mikro">Mikro</option>
                                                    @elseif( $ulpk->komoditi == "Obat Tradisional")
                                                    <option value="Obat">Obat</option>
													<option value="Obat Tradisional"  selected>Obat Tradisional</option>
													<option value="Pangan">Pangan</option>
													<option value="Kosmetik">Kosmetik</option>
													<option value="Mikro">Mikro</option>
                                                    @elseif( $ulpk->komoditi == "Pangan")
                                                    <option value="Obat">Obat</option>
													<option value="Obat Tradisional">Obat Tradisional</option>
													<option value="Pangan" selected>Pangan</option>
													<option value="Kosmetik">Kosmetik</option>
													<option value="Mikro">Mikro</option>
                                                    @elseif( $ulpk->komoditi == "Kosmetik")
                                                    <option value="Obat">Obat</option>
													<option value="Obat Tradisional">Obat Tradisional</option>
													<option value="Pangan">Pangan</option>
													<option value="Kosmetik" selected>Kosmetik</option>
													<option value="Mikro">Mikro</option>
                                                    @elseif( $ulpk->komoditi == "Mikro")
                                                    <option value="Obat">Obat</option>
													<option value="Obat Tradisional">Obat Tradisional</option>
													<option value="Pangan">Pangan</option>
													<option value="Kosmetik">Kosmetik</option>
									...
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<input type="text" value="{{ $ulpk->petugas }}" class="form-control  @error('petugas') is-invalid @enderror" id="petugas" name="petugas">
											@error('petugas')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
										...
										<div class="form-group col-xl-6 mb-12 ">
											...
											<select name="sarana" class="form-control form-select select2" data-bs-placeholder="Select Country">
                                                   @if( $ulpk->sarana == "Langsung" )
                                                    ...
                                                    @elseif($ulpk->sarana == "WaatsApp")
                                                    <option value="Langsung">Langsung</option>
													<option value="WaatsApp" selected>WaatsApp</option>
													<option value="Sosial Media">Sosial Media</option>
													<option value="KIE">KIE</option>
													<option value="Email">Email</option>
													<option value="Surat">Surat</option>
													<option value="Telepon">Telepon</option>
                                                    @elseif($ulpk->sarana == "Sosial Media")
                                                    <option value="Langsung">Langsung</option>
													<option value="WaatsApp">WaatsApp</option>
													<option value="Sosial Media" selected>Sosial Media</option>
													<option value="KIE">KIE</option>
													<option value="Email">Email</option>
													<option value="Surat">Surat</option>
													<option value="Telepon">Telepon</option>
                                                    @elseif($ulpk->sarana == "KIE")
                                                    <option value="Langsung">Langsung</option>
													<option value="WaatsApp">WaatsApp</option>
													<option value="Sosial Media">Sosial Media</option>
