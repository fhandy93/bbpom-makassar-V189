				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						...
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/updateulpk/{{$ulpk->id}}" >
									@csrf
									@method('put')
									<div class="form-row">
										<div class="col-xl-8 mb-12 ">
											...
											<div class="input-group">
												...
												<input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" value="{{$ulpk->tgl_lapor}}" type="text" name="tgl_lapor" id="tgl_lapor">
											</div>
											@error('tgl_lapor')
									...
									<div class="form-row">
										<div class="form-group col-xl-6 mb-12 ">
											...
											<select name="umur" class="form-control form-select select2" data-bs-placeholder="Select Country">
													@if($ulpk->umur=="<25 Tahun")
													<option value="<25 Tahun" selected> <25 Tahun </option>
													...
													@elseif ($ulpk->umur=="25-30 Tahun")
													<option value="<25 Tahun"> <25 Tahun </option>
													<option value="25-30 Tahun" selected>25-30 Tahun</option>
													<option value="31-40 Tahun">31-40 Tahun</option>
													<option value="41-50 Tahun">41-50 Tahun</option>
													<option value="51-60 Tahun">51-60 Tahun</option>
													<option value=">60 Tahun">>60 Tahun</option>
													@elseif ($ulpk->umur=="31-40 Tahun")
													<option value="<25 Tahun"> <25 Tahun </option>
													<option value="25-30 Tahun">25-30 Tahun</option>
													<option value="31-40 Tahun" selected>31-40 Tahun</option>
													<option value="41-50 Tahun">41-50 Tahun</option>
													<option value="51-60 Tahun">51-60 Tahun</option>
													<option value=">60 Tahun">>60 Tahun</option>
													@elseif ($ulpk->umur=="41-50 Tahun")
													<option value="<25 Tahun"> <25 Tahun </option>
													<option value="25-30 Tahun">25-30 Tahun</option>
													<option value="31-40 Tahun">31-40 Tahun</option>
													<option value="41-50 Tahun" selected>41-50 Tahun</option>
													<option value="51-60 Tahun">51-60 Tahun</option>
													<option value=">60 Tahun">>60 Tahun</option>
													@elseif ($ulpk->umur=="51-60 Tahun")
													<option value="<25 Tahun"> <25 Tahun </option>
													<option value="25-30 Tahun">25-30 Tahun</option>
													<option value="31-40 Tahun">31-40 Tahun</option>
													<option value="41-50 Tahun">41-50 Tahun</option>
													<option value="51-60 Tahun" selected>51-60 Tahun</option>
													<option value=">60 Tahun">>60 Tahun</option>
													@else
													<option value="<25 Tahun"> <25 Tahun </option>
													<option value="25-30 Tahun">25-30 Tahun</option>
													...
													<option value="41-50 Tahun">41-50 Tahun</option>
													<option value="51-60 Tahun">51-60 Tahun</option>
													<option value=">60 Tahun" selected>>60 Tahun</option>
													@endif
											</select>
										</div>
									</div>
                                    ...
                                    <div class="form-row">
										<div class="form-group col-xl-6 mb-12 ">
											...
											<select name="pekerjaan" class="form-control form-select select2" data-bs-placeholder="Select Country">
													@if($ulpk->pekerjaan=="Pegawai swasta")
													...
													@elseif($ulpk->pekerjaan=="Wiraswasta")
													...
													<option value="Dosen/Peneliti">Dosen/Peneliti</option>
													<option value="Lainnya">Lainnya</option>
													@elseif($ulpk->pekerjaan=="Pelajar/Mahasiswa")
													<option value="Pegawai swasta">Pegawai swasta</option>
													<option value="Wiraswasta">Wiraswasta</option>
													...
													<option value="Dosen/Peneliti">Dosen/Peneliti</option>
													<option value="Lainnya">Lainnya</option>
													@elseif($ulpk->pekerjaan=="Dosen/Peneliti")
													<option value="Pegawai swasta">Pegawai swasta</option>
													<option value="Wiraswasta">Wiraswasta</option>
													<option value="Pelajar/Mahasiswa">Pelajar/Mahasiswa</option>
													<option value="PNS">PNS</option>
													<option value="Dosen/Peneliti" selected>Dosen/Peneliti</option>
													<option value="Lainnya">Lainnya</option>
													@else
													<option value="Pegawai swasta">Pegawai swasta</option>
													<option value="Wiraswasta">Wiraswasta</option>
