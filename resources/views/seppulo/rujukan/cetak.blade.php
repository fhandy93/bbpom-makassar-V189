...
<div id="wrapper">
    ...
    <div id="gambar">
   <img src="{{ asset($rujuk->gambar1)}}" width="230px;" style="margin-top: 50px;" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   @if(isset($rujuk->gambar2))
   <img src="{{ asset($rujuk->gambar2)}}" width="230px;"><p>
   @endif
   @if(isset($rujuk->gambar3))
   <img src="{{ asset($rujuk->gambar3)}}" width="230px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   @endif
   @if(isset($rujuk->gambar4))
   <img src="{{ asset($rujuk->gambar4)}}" width="230px;"><p>
   @endif
   @if(isset($rujuk->gambar5))
   <img src="{{ asset($rujuk->gambar5)}}" width="230px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   @endif
   @if(isset($rujuk->gambar6))
   <img src="{{ asset($rujuk->gambar6)}}" width="230px;"><p>
   @endif
    </div>
    @endif
    ...
    <table id="table2" style="margin-top: 50px;">
        ...
        <tr>
            ...
            <td style="width: 3px;">:</td>
            <td  style="width: 350px;">{{ date('d M Y',strtotime($rujuk->tgl_terima))}}</td>
        </tr>
        <tr>
    ...
    <table id="table2" style="margin-top: 40px;text-align: center;">
        ...
        <tr>
            <td>Ana Adriyani, S.Si., Apt., M.Si</td>
            <td>{{$rujuk->user->name}}</td>
        </tr>
    </table>
    </div>
    ...
    @if(isset($trans->gambar1))
    <div id="gambar" style="margin-top: 50px;">
   <img src="{{ asset($trans->gambar1)}}" width="230px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   @if(isset($trans->gambar2))
   <img src="{{ asset($trans->gambar2)}}" width="230px;"><p>
   @endif
   @if(isset($trans->gambar3))
   <img src="{{ asset($trans->gambar3)}}" width="230px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   @endif
   @if(isset($trans->gambar4))
   <img src="{{ asset($trans->gambar4)}}" width="230px;"><p>
   @endif
   @if(isset($trans->gambar5))
   <img src="{{ asset($trans->gambar5)}}" width="230px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   @endif
   @if(isset($trans->gambar6))
   <img src="{{ asset($trans->gambar6)}}" width="230px;"><p>
   @endif
   </div>
    @endif
    <table id="table2" style="text-align: center;">
