            ...
            <div class="main-container container-fluid">
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12">
						<a href="/rujukanv"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Rujukan</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Formulir Hasil Rujukan</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/rujukhasil/{{ $rujuk->id }}" enctype="multipart/form-data">
									@csrf
									@method('put')			
