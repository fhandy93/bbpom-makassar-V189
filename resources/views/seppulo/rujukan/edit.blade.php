                            ...
                            <div class="card-body">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body tabs-menu-body">
                                        <form id="signupForm" method="post" class="form-horizontal" action="/rujukan/{{$rujuk->id}}/update" enctype="multipart/form-data">
                                        @csrf
                                        @method('put')			
                                            <div class="tab-content tab-validate">            
                                                <div class="tab-pane active" id="tab9">
                                                    <div class="form-row">
                                                        <div class="col-xl-8 mb-12 ">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" value="{{date('m/d/Y',strtotime($rujuk->tgl_terima))}}" type="text" name="tgl_terima" id="tgl_terima">
                                                            </div>
                                                            @error('tgl_terima')
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-6 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{ $rujuk->agama }}"  class="form-control  @error('agama') is-invalid @enderror" id="agama" name="agama" >
                                                            @error('agama')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-8 mb-12 ">
                                                            ...
                                                            <select name="tindak" class="form-control form-select" data-bs-placeholder="Select Country">
                                                                ...
                                                                <option value="7" selected>Dirujuk ke Kelompok substansi penindakan </option>
                                                                ...
                                                                <option value="8" selected>Dirujuk ke Kelompok Pemeriksaan</option>
                                                                <option value="9">Dirujuk keKelompok Substansi Pengujian</option>
                                                                @elseif($rujuk->tindak == 9)
                                                                <option value="5">Diselesaikan dikelompok Infokom</option>
                                                                <option value="7">Dirujuk ke Kelompok substansi penindakan </option>
                                                                <option value="8">Dirujuk ke Kelompok Pemeriksaan</option>
                                                                <option value="9" selected>Dirujuk keKelompok Substansi Pengujian</option>
                                                                @elseif($rujuk->tindak == 5)
                                                                <option value="5" selected>Diselesaikan dikelompok Infokom</option>
                                                                <option value="7">Dirujuk ke Kelompok substansi penindakan </option>
                                                                <option value="8">Dirujuk ke Kelompok Pemeriksaan</option>
                                                                <option value="9">Dirujuk keKelompok Substansi Pengujian</option>
                                                                @endif
                                                ...
                                                <div class="tab-pane" id="tab11">
                                                    ...
                                                    <h5 class="text-center" style="color: red;">Edit Gambar: *Pilih gambar hanya untuk merubah gambar</h5>
                                                    <div class="form-group">
                                                            <label class="form-label mt-0">Gambar 1</label>
                                                            @if(isset($rujuk->gambar1))
                                                            <img src="{{ $rujuk->gambar1 }}" width="100px"><br>
                                                            @endif
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <img src="{{ $rujuk->gambar2 }}" width="100px"><br>
                                                            @endif
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <img src="{{ $rujuk->gambar3 }}" width="100px"><br>
                                                            @endif
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <img src="{{ $rujuk->gambar4 }}" width="100px"><br>
                                                            @endif
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <img src="{{ $rujuk->gambar5 }}" width="100px"><br>
                                                            @endif
                                                    ...
                                                    <div class="form-group">
                                                            ...
                                                            <img src="{{ $rujuk->gambar6 }}" width="100px"><br>
                                                            @endif
