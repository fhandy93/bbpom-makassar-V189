        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Rujukan</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">SEPPULO</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Formulir Rujukan</li>
                        </ol>
                    </div>	
                </div>
                <!-- PAGE-HEADER END -->
				...
				<div class="row">
				    ...
				    @if (Auth::user()->is_permission==1 or Auth::user()->is_permission==5) 
                        <a href="/rujukanv" class="btn btn-primary my-3">View Laporan</a>
                    @endif
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Input Data Rujukan</h3>
                            </div>
                            <div class="card-body">
                                <div class="panel panel-primary">
                                    ...
                                    <div class="panel-body tabs-menu-body">
                                        <form id="signupForm" method="post" class="form-horizontal" action="/rujukans" enctype="multipart/form-data">
                                        @csrf
                                        @method('post')			
                                            <div class="tab-content tab-validate">            
                                                <div class="tab-pane active" id="tab9">
                                                    <div class="form-row">
                                                        <div class="col-xl-8 mb-12 ">
                                                            <label for="tgl_terima" class="form-label">Tanggal Terima. (Bulan-Tanggal-Tahun)</label>
                                                            <div class="input-group">
                                                                <div class="input-group-text">
                                                                    <i class="fa fa-calendar tx-16 lh-0 op-6"></i>
                                                                </div>
                                                                <input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" value="00/00/0000" type="text" name="tgl_terima" id="tgl_terima">
                                                            </div>
                                                            @error('tgl_terima')
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-8 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('ttl')}}"  class="form-control  @error('ttl') is-invalid @enderror" id="ttl" name="ttl" >
                                                            @error('ttl')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-8 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('umur')}}"  class="form-control  @error('umur') is-invalid @enderror" id="umur" name="umur" >
                                                            @error('umur')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-6 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('agama')}}"  class="form-control  @error('agama') is-invalid @enderror" id="agama" name="agama" >
                                                            @error('agama')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-6 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('pekerjaan')}}"  class="form-control  @error('pekerjaan') is-invalid @enderror" id="pekerjaan" name="pekerjaan" >
                                                            @error('pekerjaan')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-6 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('fax')}}"  class="form-control  @error('fax') is-invalid @enderror" id="fax" name="fax" >
                                                            @error('fax')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                ...
                                                <div class="tab-pane" id="tab10">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-4 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('regis')}}"  class="form-control  @error('regis') is-invalid @enderror" id="regis" name="regis" >
                                                            @error('regis')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-4 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('batch')}}"  class="form-control  @error('batch') is-invalid @enderror" id="batch" name="batch" >
                                                            @error('batch')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-4 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('kadaluarsa')}}"  class="form-control  @error('kadaluarsa') is-invalid @enderror" id="kadaluarsa" name="kadaluarsa" >
                                                            @error('kadaluarsa')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-6 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('pabrik')}}"  class="form-control  @error('pabrik') is-invalid @enderror" id="pabrik" name="pabrik" >
                                                            @error('pabrik')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-6 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('alm_pab')}}"  class="form-control  @error('alm_pab') is-invalid @enderror" id="alm_pab" name="alm_pab" >
                                                            @error('alm_pab')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-6 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('nama_kor')}}"  class="form-control  @error('nama_kor') is-invalid @enderror" id="nama_kor" name="nama_kor" >
                                                            @error('nama_kor')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-6 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('alm_kor')}}"  class="form-control  @error('alm_kor') is-invalid @enderror" id="alm_kor" name="alm_kor" >
                                                            @error('alm_kor')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-8 mb-12 ">
                                                            ...
                                                            <select name="tindak" class="form-control form-select" data-bs-placeholder="Select Country">
                                                                <option value="5">Diselesaikan dikelompok Infokom</option>
                                                                <option value="7">Dirujuk ke Kelompok substansi penindakan </option>
                                                                <option value="8">Dirujuk ke Kelompok Pemeriksaan</option>
                                                                <option value="9">Dirujuk keKelompok Substansi Pengujian</option>
                                                            </select>
                                                        </div>
                                                    </div><br>
                                                </div>
                                                <div class="tab-pane" id="tab11">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="ckeditor form-control @error('desc') is-invalid @enderror" cols="30" rows="10" name="desc" id="desc" >{{old('desc')}}</textarea>
                                                        @error('desc')
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-6 mb-12 ">
                                                            ...
                                                            <input type="text" value="{{old('tujuan')}}"  class="form-control  @error('tujuan') is-invalid @enderror" id="tujuan" name="tujuan" >
                                                            @error('tujuan')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                        <div class="col-xl-8 mb-12 ">
                                                            ...
                                                            <textarea  class="form-control  @error('hal') is-invalid @enderror" id="hal" name="hal"  rows="4">{{old('hal')}}</textarea>
                                                            @error('hal')
                                                            <span class="invalid-feedback"> {{ $message }} </span>
                                                            @enderror	
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                            <label class="form-label mt-0">Gambar 1</label>
                                                    ...
                                                    <div class="form-group">
                                                            <label class="form-label mt-0">Gambar 2</label>
                                                    ...
                                                    <div class="form-group">
                                                            <label class="form-label mt-0">Gambar 3</label>
                                                    ...
                                                    <div class="form-group">
                                                            <label class="form-label mt-0">Gambar 4</label>
                                                    ...
                                                    <div class="form-group">
                                                            <label class="form-label mt-0">Gambar 5</label>
                                                    ...
                                                    <div class="form-group">
                                                            <label class="form-label mt-0">Gambar 6</label>
