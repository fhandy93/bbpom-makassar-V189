            ...
            <div class="main-container container-fluid">
				...
				<div class="row">
					...
					<div class="col-lg-8 col-md-8">
						<a href="/v2-rujukan-view"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Rujukan</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Pengembalian Rujukan</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/v2-kembali/{{$rujuk}}" >
									@csrf
									@method('put')			
									<div class="form-group">
                                      
                                        <textarea class="ckeditor form-control @error('desc') is-invalid @enderror" cols="30" rows="10" name="desc" id="desc" ></textarea>
                                        @error('desc')
