				...
				<div class="row">		
                    ...
                    <div class="col-md-4 col-xl-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                            <a href="/v2-formrujukan" class="btn btn-success">Formulir</a>
                            </div>
                    ...
                    <div class="col-md-4 col-xl-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="/v2-rujukan-view" class="btn btn-success">Laporan</a>
                            </div>
                            <div class="card-footer">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12" >
                        <div class="card overflow-hidden" >
                            <div class="card-body pb-0 bg-recentorder">
                                <h5 class="card-title text-white" style="text-align: center;"><i class="breadcrumb-item" aria-current="page">Layanan Rujukan Version: <b>2.0</b></i></h5>
