        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Input Tag</h1>
                    <div>
                        <ol class="breadcrumb">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						<a href="/tags"><button type="button" class="btn btn-primary"><i class="fe fe-eye me-2"></i>View Tag</button></a><p>
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Form Tambah Tag</h3>
							</div>
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/tagstore" >
									@csrf
									@method('post')
									<div class="form-row">
									...
									<div class="text-center">
										<button type="submit" class="btn btn-primary" style="width:150px;">Tambah Tag</button>
