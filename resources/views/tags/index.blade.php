        ...
        <div class="side-app">
            ...
            <div class="main-container container-fluid">
                ...
                <div class="page-header">
                    <h1 class="page-title">Data Tags</h1>
                    <div>
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Tags</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Tags View</li>
                        </ol>
                    </div>
                </div>
                <!-- PAGE-HEADER END -->
                                    ...
                                    <table id="file-datatable" class="table table-bordered text-nowrap key-buttons border-bottom">
                                        ...
                                        @foreach ($tags as $key => $item)
                                            ...
                                            <td>{{ $item->keywords }}</td>
                                                <td>
                                                    <div class="btn-list">
                                                        <a href="/tag/{{$item -> id}}/edit"><button type="button" class="btn btn-sm btn-primary"><span  class="fe fe-edit">Edit</span></button></a>
                                                        <form method="POST" action="{{ route('tag.delete', $item->id) }}" style="display: inline;" hidden >
                                                            @csrf
                ...
                <a href="/taginput"><button type="button" class="btn btn-primary"><i class="fe fe-plus me-2"></i>Tambah Tag</button></a>
            </div>
        </div>
    </div>
    <!-- CONTAINER CLOSED -->
