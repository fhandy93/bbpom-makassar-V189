				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6">
						...
						<div class="card">
							...
							<div class="card-body">
								<form id="signupForm" method="post" class="form-horizontal" action="/tag/{{ $tags -> id}}" >
									@csrf
									@method('put')
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											<label for="name" class="form-label">Nama</label>
											<input type="text" value="{{ $tags -> name}}"  class="form-control  @error('name') is-invalid @enderror" id="name" name="name" >
											@error('name')
									...
									<div class="form-row">
										<div class="col-xl-6 mb-12 ">
											...
											<input type="text" value="{{ $tags -> keywords}}"  class="form-control  @error('keywords') is-invalid @enderror" id="keywords" name="keywords" >
											@error('keywords')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
									...
									<div class="form-row">
										<div class="col-xl-12 mb-12 ">
											...
											<input type="text" value="{{ $tags -> meta_desc}}"  class="form-control  @error('meta_desc') is-invalid @enderror" id="meta_desc" name="meta_desc" >
											@error('meta_desc')
											<span class="invalid-feedback"> {{ $message }} </span>
											@enderror	
										</div>
