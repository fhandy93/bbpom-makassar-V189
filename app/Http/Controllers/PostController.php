...
class PostController extends Controller
{
    ...
    public function upload(Request $request)
    {
        if($request->hasFile('upload')) {
            ...
            $request->file('upload')->move(public_path('/storage/post-image/'), $fileName);
            $CKEditorFuncNum = $request->input('CKEditorFuncNum');
            $url = asset('/storage/post-image/'.$fileName); 
    ...
    public function update(Request $request, $id)
    {
        ...
        if($new_cover){
            if($post->cover && file_exists(storage_path('app/public/' . $post->cover))){
                unlink(public_path().'/storage/'.$post->cover);
            }
        ...
        return redirect()->route('posts.index')->with('succes', 'Data berhasil diupdate');
    }
